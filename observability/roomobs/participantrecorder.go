...
type ParticipantReporterResolver interface {
	Resolve(roomName media_router.RoomName, roomID media_router.RoomID, participant media_router.ParticipantIdentity, pID media_router.ParticipantID)
	Reset()
}
...
func (r deferredParticipantResolver) Resolve(roomName media_router.RoomName, roomID media_router.RoomID, participant media_router.ParticipantIdentity, pID media_router.ParticipantID) {
