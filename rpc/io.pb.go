...
type UpdateMetricsRequest struct {
	...
	Info        *media_router.EgressInfo `protobuf:"bytes,1,opt,name=info,proto3" json:"info,omitempty"`
...
func (x *UpdateMetricsRequest) GetInfo() *media_router.EgressInfo {
	if x != nil {
		return x.Info
	}
	return nil
...
type GetIngressInfoResponse struct {
	...
	Info          *media_router.IngressInfo `protobuf:"bytes,1,opt,name=info,proto3" json:"info,omitempty"`
...
func (x *GetIngressInfoResponse) GetInfo() *media_router.IngressInfo {
	if x != nil {
		return x.Info
	}
	return nil
...
type UpdateIngressStateRequest struct {
	...
	IngressId string                     `protobuf:"bytes,1,opt,name=ingress_id,json=ingressId,proto3" json:"ingress_id,omitempty"`
	State     *media_router.IngressState `protobuf:"bytes,2,opt,name=state,proto3" json:"state,omitempty"`
}
...
func (x *UpdateIngressStateRequest) GetState() *media_router.IngressState {
	if x != nil {
		return x.State
	}
	return nil
...
type EvaluateSIPDispatchRulesResponse struct {
	...
	// What should be used for the Media Router participant identity
	...
	// What should be used for the Media Router participant name
	...
	// What should be used for the Media Router participant metadata
	...
	// What should be used for the Media Router participant attributes
	...
	// optional token that should be used when creating Media Router participant
	Token string `protobuf:"bytes,4,opt,name=token,proto3" json:"token,omitempty"`
	// optional websocket url that should be used when creating Media Router participant
	...
	// These headers are included as-is and may help identify triggered Media Router Dispatch Rule for the other SIP endpoint.
	...
	IncludeHeaders  media_router.SIPHeaderOptions `protobuf:"varint,19,opt,name=include_headers,json=includeHeaders,proto3,enum=media_router.SIPHeaderOptions" json:"include_headers,omitempty"`
	EnabledFeatures []media_router.SIPFeature     `protobuf:"varint,15,rep,packed,name=enabled_features,json=enabledFeatures,proto3,enum=media_router.SIPFeature" json:"enabled_features,omitempty"`
	...
	RoomConfig      *media_router.RoomConfiguration `protobuf:"bytes,21,opt,name=room_config,json=roomConfig,proto3" json:"room_config,omitempty"`
	MediaEncryption media_router.SIPMediaEncryption `protobuf:"varint,22,opt,name=media_encryption,json=mediaEncryption,proto3,enum=media_router.SIPMediaEncryption" json:"media_encryption,omitempty"`
}
...
func (x *EvaluateSIPDispatchRulesResponse) GetIncludeHeaders() media_router.SIPHeaderOptions {
	if x != nil {
		return x.IncludeHeaders
	}
	return media_router.SIPHeaderOptions(0)
}

func (x *EvaluateSIPDispatchRulesResponse) GetEnabledFeatures() []media_router.SIPFeature {
	if x != nil {
...
func (x *EvaluateSIPDispatchRulesResponse) GetRoomConfig() *media_router.RoomConfiguration {
	if x != nil {
		return x.RoomConfig
	}
	return nil
...
func (x *EvaluateSIPDispatchRulesResponse) GetMediaEncryption() media_router.SIPMediaEncryption {
	if x != nil {
		return x.MediaEncryption
	}
	return media_router.SIPMediaEncryption(0)
}
...
type UpdateSIPCallStateRequest struct {
	...
	CallInfo     *media_router.SIPCallInfo     `protobuf:"bytes,1,opt,name=call_info,json=callInfo,proto3" json:"call_info,omitempty"`
	TransferInfo *media_router.SIPTransferInfo `protobuf:"bytes,2,opt,name=transfer_info,json=transferInfo,proto3" json:"transfer_info,omitempty"`
}
...
func (x *UpdateSIPCallStateRequest) GetCallInfo() *media_router.SIPCallInfo {
	if x != nil {
		return x.CallInfo
	}
	return nil
...
func (x *UpdateSIPCallStateRequest) GetTransferInfo() *media_router.SIPTransferInfo {
	if x != nil {
...
type SIPCall struct {
	...
	Address   *media_router.SIPUri   `protobuf:"bytes,3,opt,name=address,proto3" json:"address,omitempty"`                        // address in the request line (INVITE)
	From      *media_router.SIPUri   `protobuf:"bytes,4,opt,name=from,proto3" json:"from,omitempty"`                              // From header
	To        *media_router.SIPUri   `protobuf:"bytes,5,opt,name=to,proto3" json:"to,omitempty"`                                  // To header
	Via       []*media_router.SIPUri `protobuf:"bytes,6,rep,name=via,proto3" json:"via,omitempty"`                                // Via headers
...
func (x *SIPCall) GetAddress() *media_router.SIPUri {
	if x != nil {
		return x.Address
	}
	return nil
...
func (x *SIPCall) GetFrom() *media_router.SIPUri {
	if x != nil {
		return x.From
	}
	return nil
...
func (x *SIPCall) GetTo() *media_router.SIPUri {
	if x != nil {
		return x.To
	}
	return nil
...
func (x *SIPCall) GetVia() []*media_router.SIPUri {
	if x != nil {
		return x.Via
	}
	return nil
...
var file_rpc_io_proto_rawDesc = []byte{
	...
	,
	...
	0x08, 0x65, 0x67, 0x72, 0x65, 0x73, 0x73, 0x49, 0x64, 0x22, 0x8c, 0x01, 0x0a, 0x14, 0x55, 0x70,
	...
	0x8d, 0x02, 0x0a, 0x16, 0x47, 0x65, 0x74, 0x49, 0x6e, 0x67, 0x72, 0x65, 0x73, 0x73, 0x49, 0x6e,
	0x66, 0x6f, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x2d, 0x0a, 0x04, 0x69, 0x6e,
	0x66, 0x6f, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x6d, 0x65, 0x64, 0x69, 0x61,
	0x5f, 0x72, 0x6f, 0x75, 0x74, 0x65, 0x72, 0x2e, 0x49, 0x6e, 0x67, 0x72, 0x65, 0x73, 0x73, 0x49,
	...
	,
	...
	,
	...
	,
	...
	0x23, 0x0a, 0x0b, 0x63, 0x61, 0x6c, 0x6c, 0x65, 0x64, 0x5f, 0x68, 0x6f, 0x73, 0x74, 0x18, 0x07,
	0x20, 0x01, 0x28, 0x09, 0x42, 0x02, 0x18, 0x01, 0x52, 0x0a, 0x63, 0x61, 0x6c, 0x6c, 0x65, 0x64,
	0x48, 0x6f, 0x73, 0x74, 0x12, 0x64, 0x0a, 0x10, 0x65, 0x78, 0x74, 0x72, 0x61, 0x5f, 0x61, 0x74,
	0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x73, 0x18, 0x09, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x39,
	...
	0x75, 0x65, 0x73, 0x74, 0x2e, 0x45, 0x78, 0x74, 0x72, 0x61, 0x41, 0x74, 0x74, 0x72, 0x69, 0x62,
	0x75, 0x74, 0x65, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x0f, 0x65, 0x78, 0x74, 0x72, 0x61,
	0x41, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x73, 0x12, 0x20, 0x0a, 0x04, 0x63, 0x61,
	0x6c, 0x6c, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0c, 0x2e, 0x72, 0x70, 0x63, 0x2e, 0x53,
	0x49, 0x50, 0x43, 0x61, 0x6c, 0x6c, 0x52, 0x04, 0x63, 0x61, 0x6c, 0x6c, 0x1a, 0x42, 0x0a, 0x14,
	...
	0x22, 0xd2, 0x0c, 0x0a, 0x20, 0x45, 0x76, 0x61, 0x6c, 0x75, 0x61, 0x74, 0x65, 0x53, 0x49, 0x50,
	...
	0x70, 0x61, 0x6e, 0x74, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52,
	...
	0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x52, 0x13,
	0x70, 0x61, 0x72, 0x74, 0x69, 0x63, 0x69, 0x70, 0x61, 0x6e, 0x74, 0x4d, 0x65, 0x74, 0x61, 0x64,
	0x61, 0x74, 0x61, 0x12, 0x77, 0x0a, 0x16, 0x70, 0x61, 0x72, 0x74, 0x69, 0x63, 0x69, 0x70, 0x61,
	0x6e, 0x74, 0x5f, 0x61, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x73, 0x18, 0x0b, 0x20,
	0x03, 0x28, 0x0b, 0x32, 0x40, 0x2e, 0x72, 0x70, 0x63, 0x2e, 0x45, 0x76, 0x61, 0x6c, 0x75, 0x61,
	0x74, 0x65, 0x53, 0x49, 0x50, 0x44, 0x69, 0x73, 0x70, 0x61, 0x74, 0x63, 0x68, 0x52, 0x75, 0x6c,
	0x65, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x2e, 0x50, 0x61, 0x72, 0x74, 0x69,
	...
	0x6e, 0x74, 0x41, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x73, 0x12, 0x23, 0x0a, 0x0b,
	0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x5f, 0x70, 0x69, 0x6e, 0x18, 0x03, 0x20, 0x01, 0x28,
	0x08, 0x42, 0x02, 0x18, 0x01, 0x52, 0x0a, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x50, 0x69,
	...
	,
	...
	0x12, 0x4c, 0x0a, 0x07, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x73, 0x18, 0x0d, 0x20, 0x03, 0x28,
	0x0b, 0x32, 0x32, 0x2e, 0x72, 0x70, 0x63, 0x2e, 0x45, 0x76, 0x61, 0x6c, 0x75, 0x61, 0x74, 0x65,
	...
	0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x07, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x73, 0x12, 0x72,
	0x0a, 0x15, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x73, 0x5f, 0x74, 0x6f, 0x5f, 0x61, 0x74, 0x74,
	0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x73, 0x18, 0x0e, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x3e, 0x2e,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x2e, 0x48, 0x65, 0x61, 0x64, 0x65, 0x72, 0x73, 0x54, 0x6f, 0x41, 0x74,
	...
	0x65, 0x73, 0x12, 0x72, 0x0a, 0x15, 0x61, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x73,
	0x5f, 0x74, 0x6f, 0x5f, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x73, 0x18, 0x12, 0x20, 0x03, 0x28,
	0x0b, 0x32, 0x3e, 0x2e, 0x72, 0x70, 0x63, 0x2e, 0x45, 0x76, 0x61, 0x6c, 0x75, 0x61, 0x74, 0x65,
	0x53, 0x49, 0x50, 0x44, 0x69, 0x73, 0x70, 0x61, 0x74, 0x63, 0x68, 0x52, 0x75, 0x6c, 0x65, 0x73,
	...
	,
	...
	0x63, 0x61, 0x6c, 0x6c, 0x5f, 0x64, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x11, 0x20,
	...
	,
	...
	,
	...
	,
	...
	0x74, 0x79, 0x12, 0x42, 0x0a, 0x0d, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x49, 0x6e, 0x67, 0x72,
	0x65, 0x73, 0x73, 0x12, 0x19, 0x2e, 0x6d, 0x65, 0x64, 0x69, 0x61, 0x5f, 0x72, 0x6f, 0x75, 0x74,
	0x65, 0x72, 0x2e, 0x49, 0x6e, 0x67, 0x72, 0x65, 0x73, 0x73, 0x49, 0x6e, 0x66, 0x6f, 0x1a, 0x16,
	...
	,
...
var file_rpc_io_proto_goTypes = []interface{}{
	...
	(*media_router.EgressInfo)(nil),           // 18: media_router.EgressInfo
	(*media_router.IngressInfo)(nil),          // 19: media_router.IngressInfo
	(*media_router.IngressState)(nil),         // 20: media_router.IngressState
	(media_router.SIPHeaderOptions)(0),        // 21: media_router.SIPHeaderOptions
	(media_router.SIPFeature)(0),              // 22: media_router.SIPFeature
	(*durationpb.Duration)(nil),               // 23: google.protobuf.Duration
	(*media_router.RoomConfiguration)(nil),    // 24: media_router.RoomConfiguration
	(media_router.SIPMediaEncryption)(0),      // 25: media_router.SIPMediaEncryption
	(*media_router.SIPCallInfo)(nil),          // 26: media_router.SIPCallInfo
	(*media_router.SIPTransferInfo)(nil),      // 27: media_router.SIPTransferInfo
	(*media_router.SIPUri)(nil),               // 28: media_router.SIPUri
	(*media_router.ListEgressRequest)(nil),    // 29: media_router.ListEgressRequest
	(*emptypb.Empty)(nil),                     // 30: google.protobuf.Empty
	(*media_router.ListEgressResponse)(nil),   // 31: media_router.ListEgressResponse
}
var file_rpc_io_proto_depIdxs = []int32{
	18, // 0: rpc.UpdateMetricsRequest.info:type_name -> media_router.EgressInfo
	19, // 1: rpc.GetIngressInfoResponse.info:type_name -> media_router.IngressInfo
	12, // 2: rpc.GetIngressInfoResponse.logging_fields:type_name -> rpc.GetIngressInfoResponse.LoggingFieldsEntry
	20, // 3: rpc.UpdateIngressStateRequest.state:type_name -> media_router.IngressState
	...
	21, // 12: rpc.EvaluateSIPDispatchRulesResponse.include_headers:type_name -> media_router.SIPHeaderOptions
	22, // 13: rpc.EvaluateSIPDispatchRulesResponse.enabled_features:type_name -> media_router.SIPFeature
	...
	24, // 16: rpc.EvaluateSIPDispatchRulesResponse.room_config:type_name -> media_router.RoomConfiguration
	25, // 17: rpc.EvaluateSIPDispatchRulesResponse.media_encryption:type_name -> media_router.SIPMediaEncryption
	26, // 18: rpc.UpdateSIPCallStateRequest.call_info:type_name -> media_router.SIPCallInfo
	27, // 19: rpc.UpdateSIPCallStateRequest.transfer_info:type_name -> media_router.SIPTransferInfo
	28, // 20: rpc.SIPCall.address:type_name -> media_router.SIPUri
	28, // 21: rpc.SIPCall.from:type_name -> media_router.SIPUri
	28, // 22: rpc.SIPCall.to:type_name -> media_router.SIPUri
	28, // 23: rpc.SIPCall.via:type_name -> media_router.SIPUri
	18, // 24: rpc.IOInfo.CreateEgress:input_type -> media_router.EgressInfo
	18, // 25: rpc.IOInfo.UpdateEgress:input_type -> media_router.EgressInfo
	1,  // 26: rpc.IOInfo.GetEgress:input_type -> rpc.GetEgressRequest
	29, // 27: rpc.IOInfo.ListEgress:input_type -> media_router.ListEgressRequest
	2,  // 28: rpc.IOInfo.UpdateMetrics:input_type -> rpc.UpdateMetricsRequest
	19, // 29: rpc.IOInfo.CreateIngress:input_type -> media_router.IngressInfo
	...
	18, // 37: rpc.IOInfo.GetEgress:output_type -> media_router.EgressInfo
	31, // 38: rpc.IOInfo.ListEgress:output_type -> media_router.ListEgressResponse
