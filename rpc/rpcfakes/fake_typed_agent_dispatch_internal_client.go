...
type FakeTypedAgentDispatchInternalClient struct {
	...
	createDispatchArgsForCall []struct {
		...
		arg2 rpc.RoomTopic
		arg3 *media_router.AgentDispatch
		arg4 []psrpc.RequestOption
	}
	createDispatchReturns struct {
		result1 *media_router.AgentDispatch
		result2 error
	}
	...
	deleteDispatchArgsForCall []struct {
		arg1 context.Context
		arg2 rpc.RoomTopic
		arg3 *media_router.DeleteAgentDispatchRequest
		arg4 []psrpc.RequestOption
	}
	...
	listDispatchArgsForCall []struct {
		arg1 context.Context
		arg2 rpc.RoomTopic
		arg3 *media_router.ListAgentDispatchRequest
		arg4 []psrpc.RequestOption
	}
	listDispatchReturns struct {
		result1 *media_router.ListAgentDispatchResponse
		result2 error
	}
