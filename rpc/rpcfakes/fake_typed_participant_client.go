...
type FakeTypedParticipantClient struct {
	...
	forwardParticipantArgsForCall []struct {
		...
		arg3 *media_router.ForwardParticipantRequest
		arg4 []psrpc.RequestOption
	}
	forwardParticipantReturns struct {
		result1 *media_router.ForwardParticipantResponse
		result2 error
	}
	...
	moveParticipantArgsForCall []struct {
		arg1 context.Context
		arg2 rpc.ParticipantTopic
		arg3 *media_router.MoveParticipantRequest
		arg4 []psrpc.RequestOption
	}
	moveParticipantReturns struct {
		result1 *media_router.MoveParticipantResponse
		result2 error
	}
	...
	mutePublishedTrackArgsForCall []struct {
		arg1 context.Context
		arg2 rpc.ParticipantTopic
		arg3 *media_router.MuteRoomTrackRequest
		arg4 []psrpc.RequestOption
	}
	mutePublishedTrackReturns struct {
		result1 *media_router.MuteRoomTrackResponse
		result2 error
	}
	...
	removeParticipantArgsForCall []struct {
		arg1 context.Context
		arg2 rpc.ParticipantTopic
		arg3 *media_router.RoomParticipantIdentity
		arg4 []psrpc.RequestOption
	}
	removeParticipantReturns struct {
		result1 *media_router.RemoveParticipantResponse
		result2 error
	}
	...
	updateParticipantArgsForCall []struct {
		arg1 context.Context
		arg2 rpc.ParticipantTopic
		arg3 *media_router.UpdateParticipantRequest
		arg4 []psrpc.RequestOption
	}
	updateParticipantReturns struct {
		result1 *media_router.ParticipantInfo
		result2 error
	}
	...
	updateSubscriptionsArgsForCall []struct {
		arg1 context.Context
		arg2 rpc.ParticipantTopic
		arg3 *media_router.UpdateSubscriptionsRequest
		arg4 []psrpc.RequestOption
	}
	updateSubscriptionsReturns struct {
		result1 *media_router.UpdateSubscriptionsResponse
		result2 error
	}
