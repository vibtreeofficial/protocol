...
type FakeTypedRoomClient struct {
	...
	deleteRoomArgsForCall []struct {
		...
		arg2 rpc.RoomTopic
		arg3 *media_router.DeleteRoomRequest
		arg4 []psrpc.RequestOption
	}
	deleteRoomReturns struct {
		result1 *media_router.DeleteRoomResponse
		result2 error
	}
	...
	sendDataArgsForCall []struct {
		arg1 context.Context
		arg2 rpc.RoomTopic
		arg3 *media_router.SendDataRequest
		arg4 []psrpc.RequestOption
	}
	sendDataReturns struct {
		result1 *media_router.SendDataResponse
		result2 error
	}
	...
	updateRoomMetadataArgsForCall []struct {
		arg1 context.Context
		arg2 rpc.RoomTopic
		arg3 *media_router.UpdateRoomMetadataRequest
		arg4 []psrpc.RequestOption
	}
	updateRoomMetadataReturns struct {
		result1 *media_router.Room
		result2 error
	}
