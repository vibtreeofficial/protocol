...
const (
	AnalyticsRecorderService_IngestStats_FullMethodName          = "/rpc.AnalyticsRecorderService/IngestStats"
	AnalyticsRecorderService_IngestEvents_FullMethodName         = "/rpc.AnalyticsRecorderService/IngestEvents"
	AnalyticsRecorderService_IngestNodeRoomStates_FullMethodName = "/rpc.AnalyticsRecorderService/IngestNodeRoomStates"
)
...
type AnalyticsRecorderService_IngestStatsClient interface {
	Send(*media_router.AnalyticsStats) error
...
func (x *analyticsRecorderServiceIngestStatsClient) Send(m *media_router.AnalyticsStats) error {
...
type AnalyticsRecorderService_IngestEventsClient interface {
	Send(*media_router.AnalyticsEvents) error
	CloseAndRecv() (*emptypb.Empty, error)
	grpc.ClientStream
}
...
func (x *analyticsRecorderServiceIngestEventsClient) Send(m *media_router.AnalyticsEvents) error {
	return x.ClientStream.SendMsg(m)
}
...
type AnalyticsRecorderService_IngestNodeRoomStatesClient interface {
	Send(*media_router.AnalyticsNodeRooms) error
	CloseAndRecv() (*emptypb.Empty, error)
	grpc.ClientStream
}
...
func (x *analyticsRecorderServiceIngestNodeRoomStatesClient) Send(m *media_router.AnalyticsNodeRooms) error {
	return x.ClientStream.SendMsg(m)
}
...
type AnalyticsRecorderService_IngestStatsServer interface {
	...
	Recv() (*media_router.AnalyticsStats, error)
	grpc.ServerStream
}
...
func (x *analyticsRecorderServiceIngestStatsServer) Recv() (*media_router.AnalyticsStats, error) {
	m := new(media_router.AnalyticsStats)
...
type AnalyticsRecorderService_IngestEventsServer interface {
	SendAndClose(*emptypb.Empty) error
	Recv() (*media_router.AnalyticsEvents, error)
	grpc.ServerStream
}
...
func (x *analyticsRecorderServiceIngestEventsServer) Recv() (*media_router.AnalyticsEvents, error) {
	m := new(media_router.AnalyticsEvents)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
type AnalyticsRecorderService_IngestNodeRoomStatesServer interface {
	SendAndClose(*emptypb.Empty) error
	Recv() (*media_router.AnalyticsNodeRooms, error)
	grpc.ServerStream
}
...
func (x *analyticsRecorderServiceIngestNodeRoomStatesServer) Recv() (*media_router.AnalyticsNodeRooms, error) {
	m := new(media_router.AnalyticsNodeRooms)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
var AnalyticsRecorderService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "rpc.AnalyticsRecorderService",
