...
import (
	context "context"
	vibtree "github.com/vibtreeofficial/protocol/media-router"
...
type AnalyticsRecorderServiceClient interface {
	IngestStats(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[vibtree.AnalyticsStats, emptypb.Empty], error)
	IngestEvents(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[vibtree.AnalyticsEvents, emptypb.Empty], error)
	IngestNodeRoomStates(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[vibtree.AnalyticsNodeRooms, emptypb.Empty], error)
}
...
func (c *analyticsRecorderServiceClient) IngestStats(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[vibtree.AnalyticsStats, emptypb.Empty], error) {
	...
	x := &grpc.GenericClientStream[vibtree.AnalyticsStats, emptypb.Empty]{ClientStream: stream}
	return x, nil
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type AnalyticsRecorderService_IngestStatsClient = grpc.ClientStreamingClient[vibtree.AnalyticsStats, emptypb.Empty]

func (c *analyticsRecorderServiceClient) IngestEvents(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[vibtree.AnalyticsEvents, emptypb.Empty], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	...
	x := &grpc.GenericClientStream[vibtree.AnalyticsEvents, emptypb.Empty]{ClientStream: stream}
	return x, nil
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type AnalyticsRecorderService_IngestEventsClient = grpc.ClientStreamingClient[vibtree.AnalyticsEvents, emptypb.Empty]

func (c *analyticsRecorderServiceClient) IngestNodeRoomStates(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[vibtree.AnalyticsNodeRooms, emptypb.Empty], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	...
	x := &grpc.GenericClientStream[vibtree.AnalyticsNodeRooms, emptypb.Empty]{ClientStream: stream}
	return x, nil
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type AnalyticsRecorderService_IngestNodeRoomStatesClient = grpc.ClientStreamingClient[vibtree.AnalyticsNodeRooms, emptypb.Empty]
...
type AnalyticsRecorderServiceServer interface {
	IngestStats(grpc.ClientStreamingServer[vibtree.AnalyticsStats, emptypb.Empty]) error
	IngestEvents(grpc.ClientStreamingServer[vibtree.AnalyticsEvents, emptypb.Empty]) error
	IngestNodeRoomStates(grpc.ClientStreamingServer[vibtree.AnalyticsNodeRooms, emptypb.Empty]) error
...
func (UnimplementedAnalyticsRecorderServiceServer) IngestStats(grpc.ClientStreamingServer[vibtree.AnalyticsStats, emptypb.Empty]) error {
	return status.Errorf(codes.Unimplemented, "method IngestStats not implemented")
}
func (UnimplementedAnalyticsRecorderServiceServer) IngestEvents(grpc.ClientStreamingServer[vibtree.AnalyticsEvents, emptypb.Empty]) error {
	return status.Errorf(codes.Unimplemented, "method IngestEvents not implemented")
}
func (UnimplementedAnalyticsRecorderServiceServer) IngestNodeRoomStates(grpc.ClientStreamingServer[vibtree.AnalyticsNodeRooms, emptypb.Empty]) error {
...
func _AnalyticsRecorderService_IngestStats_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(AnalyticsRecorderServiceServer).IngestStats(&grpc.GenericServerStream[vibtree.AnalyticsStats, emptypb.Empty]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type AnalyticsRecorderService_IngestStatsServer = grpc.ClientStreamingServer[vibtree.AnalyticsStats, emptypb.Empty]

func _AnalyticsRecorderService_IngestEvents_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(AnalyticsRecorderServiceServer).IngestEvents(&grpc.GenericServerStream[vibtree.AnalyticsEvents, emptypb.Empty]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type AnalyticsRecorderService_IngestEventsServer = grpc.ClientStreamingServer[vibtree.AnalyticsEvents, emptypb.Empty]

func _AnalyticsRecorderService_IngestNodeRoomStates_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(AnalyticsRecorderServiceServer).IngestNodeRoomStates(&grpc.GenericServerStream[vibtree.AnalyticsNodeRooms, emptypb.Empty]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type AnalyticsRecorderService_IngestNodeRoomStatesServer = grpc.ClientStreamingServer[vibtree.AnalyticsNodeRooms, emptypb.Empty]
