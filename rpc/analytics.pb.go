...
const file_rpc_analytics_proto_rawDesc = "" +
	"\n" +
	"\x13rpc/analytics.proto\x12\alivekit\x1a\x1bgoogle/protobuf/empty.proto\x1a\x17vibtree_analytics.proto2\xf5\x01\n" +
	"\x18AnalyticsRecorderService\x12B\n" +
	"\vIngestStats\x12\x17.vibtree.AnalyticsStats\x1a\x16.google.protobuf.Empty\"\x00(\x01\x12D\n" +
	"\fIngestEvents\x12\x18.vibtree.AnalyticsEvents\x1a\x16.google.protobuf.Empty\"\x00(\x01\x12O\n" +
	"\x14IngestNodeRoomStates\x12\x1b.vibtree.AnalyticsNodeRooms\x1a\x16.google.protobuf.Empty\"\x00(\x01B)Z'github.com/vibtreeofficial/protocol/rpcb\x06proto3"

var file_rpc_analytics_proto_goTypes = []any{
	(*vibtree.AnalyticsStats)(nil),     // 0: vibtree.AnalyticsStats
	(*vibtree.AnalyticsEvents)(nil),    // 1: vibtree.AnalyticsEvents
	(*vibtree.AnalyticsNodeRooms)(nil), // 2: vibtree.AnalyticsNodeRooms
	(*emptypb.Empty)(nil),              // 3: google.protobuf.Empty
}
var file_rpc_analytics_proto_depIdxs = []int32{
	0, // 0: livekit.AnalyticsRecorderService.IngestStats:input_type -> vibtree.AnalyticsStats
	1, // 1: livekit.AnalyticsRecorderService.IngestEvents:input_type -> vibtree.AnalyticsEvents
	2, // 2: livekit.AnalyticsRecorderService.IngestNodeRoomStates:input_type -> vibtree.AnalyticsNodeRooms
