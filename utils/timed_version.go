...
func TimedVersionFromProto(proto *media_router.TimedVersion) TimedVersion {
...
func (t TimedVersion) ToProto() *media_router.TimedVersion {
	ts, ticks := timedVersionComponents(t)
	return &media_router.TimedVersion{
		UnixMicro: ts,
		Ticks:     ticks,
	}
}
