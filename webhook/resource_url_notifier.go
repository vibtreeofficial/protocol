...
type ResourceURLNotifierParams struct {
	...
	APIKey     string
	APISecret  string
	FieldsHook func(whi *media_router.WebhookInfo)
	FilterParams
}
...
type ResourceURLNotifier struct {
	...
	processedHook func(ctx context.Context, whi *media_router.WebhookInfo)
...
func (r *ResourceURLNotifier) RegisterProcessedHook(hook func(ctx context.Context, whi *media_router.WebhookInfo)) {
	r.mu.Lock()
	defer r.mu.Unlock()
	r.processedHook = hook
}

func (r *ResourceURLNotifier) getProcessedHook() func(ctx context.Context, whi *media_router.WebhookInfo) {
	r.mu.RLock()
	defer r.mu.RUnlock()
	return r.processedHook
}

func (r *ResourceURLNotifier) QueueNotify(ctx context.Context, event *media_router.WebhookEvent, opts ...NotifyOption) error {
...
func (r *ResourceURLNotifier) send(event *media_router.WebhookEvent, params *ResourceURLNotifierParams) error {
