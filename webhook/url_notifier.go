...
func (n *URLNotifier) RegisterProcessedHook(hook func(ctx context.Context, whi *media_router.WebhookInfo)) {
	n.mu.Lock()
	defer n.mu.Unlock()
	n.processedHook = hook
}

func (n *URLNotifier) getProcessedHook() func(ctx context.Context, whi *media_router.WebhookInfo) {
	n.mu.RLock()
	defer n.mu.RUnlock()
	return n.processedHook
}

func (n *URLNotifier) QueueNotify(ctx context.Context, event *media_router.WebhookEvent, opts ...NotifyOption) error {
...
func (n *URLNotifier) send(event *media_router.WebhookEvent, params *URLNotifierParams) error {
	// set dropped count
