...
func NewRoomServiceProtobufClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) RoomService {
	...
	serviceURL += baseServicePath(pathPrefix, "media_router", "RoomService")
	urls := [13]string{
...
const RoomServicePathPrefix = "/twirp/media_router.RoomService/"
...
func (s *roomServiceServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	if pkgService != "media_router.RoomService" {
...
func (s *roomServiceServer) PathPrefix() string {
	return baseServicePath(s.pathPrefix, "media_router", "RoomService")
}

var twirpFileDescriptor3 = []byte{
	// 1407 bytes of a gzipped FileDescriptorProto
	,
}
