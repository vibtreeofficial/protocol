...
const file_media_router_agent_proto_rawDesc = "" +
	"\n" +
	"\x13media_router_agent.proto\x12\amedia_router\x1a\x14media_router_models.proto\"\xd6\x02\n" +
	"\x03Job\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x1f\n" +
	"\vdispatch_id\x18\t \x01(\tR\n" +
	"dispatchId\x12$\n" +
	"\x04type\x18\x02 \x01(\x0e2\x10.media_router.JobTypeR\x04type\x12!\n" +
	"\x04room\x18\x03 \x01(\v2\r.media_router.RoomR\x04room\x12?\n" +
	"\vparticipant\x18\x04 \x01(\v2\x18.media_router.ParticipantInfoH\x00R\vparticipant\x88\x01\x01\x12 \n" +
	...
	"\x05state\x18\b \x01(\v2\x11.media_router.JobStateR\x05stateB\x0e\n" +
	"\f_participant\"\x90\x02\n" +
	"\bJobState\x12*\n" +
	"\x06status\x18\x01 \x01(\x0e2\x12.media_router.JobStatusR\x06status\x12\x14\n" +
	...
	"\rWorkerMessage\x12<\n" +
	"\bregister\x18\x01 \x01(\v2\x1e.media_router.RegisterWorkerRequestH\x00R\bregister\x12C\n" +
	"\favailability\x18\x02 \x01(\v2\x1d.media_router.AvailabilityResponseH\x00R\favailability\x12B\n" +
	"\rupdate_worker\x18\x03 \x01(\v2\x1b.media_router.UpdateWorkerStatusH\x00R\fupdateWorker\x129\n" +
	"\n" +
	"update_job\x18\x04 \x01(\v2\x18.media_router.UpdateJobStatusH\x00R\tupdateJob\x12)\n" +
	"\x04ping\x18\x05 \x01(\v2\x13.media_router.WorkerPingH\x00R\x04ping\x12@\n" +
	"\fsimulate_job\x18\x06 \x01(\v2\x1b.media_router.SimulateJobRequestH\x00R\vsimulateJob\x12=\n" +
	"\vmigrate_job\x18\a \x01(\v2\x1a.media_router.MigrateJobRequestH\x00R\n" +
	"migrateJobB\t\n" +
	"\amessage\"\xbf\x02\n" +
	"\rServerMessage\x12=\n" +
	"\bregister\x18\x01 \x01(\v2\x1f.media_router.RegisterWorkerResponseH\x00R\bregister\x12B\n" +
	"\favailability\x18\x02 \x01(\v2\x1c.media_router.AvailabilityRequestH\x00R\favailability\x128\n" +
	"\n" +
	"assignment\x18\x03 \x01(\v2\x16.media_router.JobAssignmentH\x00R\n" +
	"assignment\x12;\n" +
	"\vtermination\x18\x05 \x01(\v2\x17.media_router.JobTerminationH\x00R\vtermination\x12)\n" +
	"\x04pong\x18\x04 \x01(\v2\x13.media_router.WorkerPongH\x00R\x04pongB\t\n" +
	"\amessage\"\x99\x01\n" +
	"\x12SimulateJobRequest\x12$\n" +
	"\x04type\x18\x01 \x01(\x0e2\x10.media_router.JobTypeR\x04type\x12!\n" +
	"\x04room\x18\x02 \x01(\v2\r.media_router.RoomR\x04room\x12:\n" +
	"\vparticipant\x18\x03 \x01(\v2\x18.media_router.ParticipantInfoR\vparticipant\"*\n" +
	"\n" +
	"WorkerPing\x12\x1c\n" +
	...
	"\x04type\x18\x01 \x01(\x0e2\x10.media_router.JobTypeR\x04type\x12\x1d\n" +
	"\n" +
	...
	"\x13allowed_permissions\x18\a \x01(\v2\x1e.media_router.ParticipantPermissionR\x12allowedPermissionsB\f\n" +
	"\n" +
	"_namespace\"k\n" +
	...
	"\x03job\x18\x01 \x01(\v2\f.media_router.JobR\x03job\x12\x1a\n" +
	...
	"\x16participant_attributes\x18\a \x03(\v28.media_router.AvailabilityResponse.ParticipantAttributesEntryR\x15participantAttributes\x1aH\n" +
	"\x1aParticipantAttributesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"j\n" +
	"\x0fUpdateJobStatus\x12\x15\n" +
	"\x06job_id\x18\x01 \x01(\tR\x05jobId\x12*\n" +
	"\x06status\x18\x02 \x01(\x0e2\x12.media_router.JobStatusR\x06status\x12\x14\n" +
	"\x05error\x18\x03 \x01(\tR\x05error\"\x84\x01\n" +
	"\x12UpdateWorkerStatus\x122\n" +
	"\x06status\x18\x01 \x01(\x0e2\x15.media_router.WorkerStatusH\x00R\x06status\x88\x01\x01\x12\x12\n" +
	"\x04load\x18\x03 \x01(\x02R\x04load\x12\x1b\n" +
	"\tjob_count\x18\x04 \x01(\rR\bjobCountB\t\n" +
	"\a_status\"d\n" +
	"\rJobAssignment\x12\x1e\n" +
	"\x03job\x18\x01 \x01(\v2\f.media_router.JobR\x03job\x12\x15\n" +
	...
	"\tJS_FAILED\x10\x03BNZ+github.com/media_routerofficial/protocol/media_router\xaa\x02\rVibTree.Proto\xea\x02\x0eVibTree::Protob\x06proto3"

var (
	file_media_router_agent_proto_rawDescOnce sync.Once
	file_media_router_agent_proto_rawDescData []byte
)

func file_media_router_agent_proto_rawDescGZIP() []byte {
	file_media_router_agent_proto_rawDescOnce.Do(func() {
		file_media_router_agent_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_media_router_agent_proto_rawDesc), len(file_media_router_agent_proto_rawDesc)))
	})
...
var file_media_router_agent_proto_goTypes = []any{
...
func file_media_router_agent_proto_init() {
	...
	file_media_router_agent_proto_msgTypes[0].OneofWrappers = []any{}
	file_media_router_agent_proto_msgTypes[2].OneofWrappers = []any{
	...
	file_media_router_agent_proto_msgTypes[3].OneofWrappers = []any{
	...
	file_media_router_agent_proto_msgTypes[7].OneofWrappers = []any{}
	file_media_router_agent_proto_msgTypes[13].OneofWrappers = []any{}
	file_media_router_agent_proto_msgTypes[14].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_media_router_agent_proto_rawDesc), len(file_media_router_agent_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   17,
			NumExtensions: 0,
			NumServices:   0,
