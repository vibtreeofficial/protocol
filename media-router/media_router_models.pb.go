...
const file_media_router_models_proto_rawDesc = "" +
	"\n" +
	"\x14media_router_models.proto\x12\amedia_router\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x15media_router_metrics.proto\"=\n" +
	"\n" +
	"Pagination\x12\x19\n" +
	...
	"\x0eenabled_codecs\x18\a \x03(\v2\x0e.media_router.CodecR\renabledCodecs\x12\x1a\n" +
	...
	"\aversion\x18\r \x01(\v2\x15.media_router.TimedVersionR\aversion\"8\n" +
	"\x05Codec\x12\x12\n" +
	...
	"\x13can_publish_sources\x18\t \x03(\x0e2\x14.media_router.TrackSourceR\x11canPublishSources\x12\x16\n" +
	...
	"\x05state\x18\x03 \x01(\x0e2\x1e.media_router.ParticipantInfo.StateR\x05state\x12*\n" +
	"\x06tracks\x18\x04 \x03(\v2\x12.media_router.TrackInfoR\x06tracks\x12\x1a\n" +
	...
	" \x01(\rR\aversion\x12>\n" +
	"\n" +
	"permission\x18\v \x01(\v2\x1e.media_router.ParticipantPermissionR\n" +
	"permission\x12\x16\n" +
	"\x06region\x18\f \x01(\tR\x06region\x12!\n" +
	"\fis_publisher\x18\r \x01(\bR\visPublisher\x121\n" +
	"\x04kind\x18\x0e \x01(\x0e2\x1d.media_router.ParticipantInfo.KindR\x04kind\x12H\n" +
	"\n" +
	"attributes\x18\x0f \x03(\v2(.media_router.ParticipantInfo.AttributesEntryR\n" +
	"attributes\x12F\n" +
	"\x11disconnect_reason\x18\x10 \x01(\x0e2\x19.media_router.DisconnectReasonR\x10disconnectReason\x12F\n" +
	"\fkind_details\x18\x12 \x03(\x0e2#.media_router.ParticipantInfo.KindDetailR\vkindDetails\x1a=\n" +
	...
	"\x06layers\x18\x04 \x03(\v2\x13.media_router.VideoLayerR\x06layers\"\xfa\x05\n" +
	"\tTrackInfo\x12\x10\n" +
	"\x03sid\x18\x01 \x01(\tR\x03sid\x12&\n" +
	"\x04type\x18\x02 \x01(\x0e2\x12.media_router.TrackTypeR\x04type\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name\x12\x14\n" +
	"\x05muted\x18\x04 \x01(\bR\x05muted\x12\x18\n" +
	"\x05width\x18\x05 \x01(\rB\x02\x18\x01R\x05width\x12\x1a\n" +
	"\x06height\x18\x06 \x01(\rB\x02\x18\x01R\x06height\x12\x1c\n" +
	"\tsimulcast\x18\a \x01(\bR\tsimulcast\x12#\n" +
	"\vdisable_dtx\x18\b \x01(\bB\x02\x18\x01R\n" +
	"disableDtx\x12,\n" +
	"\x06source\x18\t \x01(\x0e2\x14.media_router.TrackSourceR\x06source\x12/\n" +
	"\x06layers\x18\n" +
	" \x03(\v2\x13.media_router.VideoLayerB\x02\x18\x01R\x06layers\x12\x1b\n" +
	"\tmime_type\x18\v \x01(\tR\bmimeType\x12\x10\n" +
	"\x03mid\x18\f \x01(\tR\x03mid\x123\n" +
	"\x06codecs\x18\r \x03(\v2\x1b.media_router.SimulcastCodecInfoR\x06codecs\x12\x1a\n" +
	"\x06stereo\x18\x0e \x01(\bB\x02\x18\x01R\x06stereo\x12\x1f\n" +
	"\vdisable_red\x18\x0f \x01(\bR\n" +
	"disableRed\x128\n" +
	"\n" +
	"encryption\x18\x10 \x01(\x0e2\x18.media_router.Encryption.TypeR\n" +
	"encryption\x12\x16\n" +
	"\x06stream\x18\x11 \x01(\tR\x06stream\x12/\n" +
	"\aversion\x18\x12 \x01(\v2\x15.media_router.TimedVersionR\aversion\x12A\n" +
	"\x0eaudio_features\x18\x13 \x03(\x0e2\x1a.media_router.AudioTrackFeatureR\raudioFeatures\x12J\n" +
	"\x13backup_codec_policy\x18\x14 \x01(\x0e2\x1a.media_router.BackupCodecPolicyR\x11backupCodecPolicy\"\xd0\x01\n" +
	"\n" +
	"VideoLayer\x12/\n" +
	"\aquality\x18\x01 \x01(\x0e2\x15.media_router.VideoQualityR\aquality\x12\x14\n" +
	...
	"\n" +
	"DataPacket\x120\n" +
	"\x04kind\x18\x01 \x01(\x0e2\x18.media_router.DataPacket.KindB\x02\x18\x01R\x04kind\x121\n" +
	...
	"\x04user\x18\x02 \x01(\v2\x13.media_router.UserPacketH\x00R\x04user\x12<\n" +
	"\aspeaker\x18\x03 \x01(\v2\x1c.media_router.ActiveSpeakerUpdateB\x02\x18\x01H\x00R\aspeaker\x12-\n" +
	"\bsip_dtmf\x18\x06 \x01(\v2\x10.media_router.SipDTMFH\x00R\asipDtmf\x12>\n" +
	"\rtranscription\x18\a \x01(\v2\x16.media_router.TranscriptionH\x00R\rtranscription\x121\n" +
	"\ametrics\x18\b \x01(\v2\x15.media_router.MetricsBatchH\x00R\ametrics\x129\n" +
	"\fchat_message\x18\t \x01(\v2\x14.media_router.ChatMessageH\x00R\vchatMessage\x126\n" +
	"\vrpc_request\x18\n" +
	" \x01(\v2\x13.media_router.RpcRequestH\x00R\n" +
	"rpcRequest\x12*\n" +
	"\arpc_ack\x18\v \x01(\v2\x0f.media_router.RpcAckH\x00R\x06rpcAck\x129\n" +
	"\frpc_response\x18\f \x01(\v2\x14.media_router.RpcResponseH\x00R\vrpcResponse\x12A\n" +
	"\rstream_header\x18\r \x01(\v2\x1a.media_router.DataStream.HeaderH\x00R\fstreamHeader\x12>\n" +
	"\fstream_chunk\x18\x0e \x01(\v2\x19.media_router.DataStream.ChunkH\x00R\vstreamChunk\x12D\n" +
	"\x0estream_trailer\x18\x0f \x01(\v2\x1b.media_router.DataStream.TrailerH\x00R\rstreamTrailer\x12\x1a\n" +
	...
	"\bspeakers\x18\x01 \x03(\v2\x14.media_router.SpeakerInfoR\bspeakers:\x02\x18\x01\"M\n" +
	...
	"\bsegments\x18\x04 \x03(\v2\x1d.media_router.TranscriptionSegmentR\bsegments\"\xa6\x01\n" +
	...
	"\x05error\x18\x03 \x01(\v2\x11.media_router.RpcErrorH\x00R\x05errorB\a\n" +
	"\x05value\"L\n" +
	"\bRpcError\x12\x12\n" +
	...
	"\n" +
	"ServerInfo\x125\n" +
	"\aedition\x18\x01 \x01(\x0e2\x1b.media_router.ServerInfo.EditionR\aedition\x12\x18\n" +
	...
	"\n" +
	"ClientInfo\x12)\n" +
	"\x03sdk\x18\x01 \x01(\x0e2\x17.media_router.ClientInfo.SDKR\x03sdk\x12\x18\n" +
	"\aversion\x18\x02 \x01(\tR\aversion\x12\x1a\n" +
	...
	"\x05video\x18\x01 \x01(\v2\x1b.media_router.VideoConfigurationR\x05video\x123\n" +
	"\x06screen\x18\x02 \x01(\v2\x1b.media_router.VideoConfigurationR\x06screen\x12I\n" +
	"\x11resume_connection\x18\x03 \x01(\x0e2\x1c.media_router.ClientConfigSettingR\x10resumeConnection\x12@\n" +
	"\x0fdisabled_codecs\x18\x04 \x01(\v2\x17.media_router.DisabledCodecsR\x0edisabledCodecs\x12=\n" +
	"\vforce_relay\x18\x05 \x01(\x0e2\x1c.media_router.ClientConfigSettingR\n" +
	"forceRelay\"]\n" +
	"\x12VideoConfiguration\x12G\n" +
	"\x10hardware_encoder\x18\x01 \x01(\x0e2\x1c.media_router.ClientConfigSettingR\x0fhardwareEncoder\"b\n" +
	"\x0eDisabledCodecs\x12&\n" +
	"\x06codecs\x18\x01 \x03(\v2\x0e.media_router.CodecR\x06codecs\x12(\n" +
	"\apublish\x18\x02 \x03(\v2\x0e.media_router.CodecR\apublish\"\xed\x02\n" +
	"\bRTPDrift\x129\n" +
	"\n" +
	...
	"\rgap_histogram\x18\x18 \x03(\v2#.media_router.RTPStats.GapHistogramEntryR\fgapHistogram\x12\x14\n" +
	...
	"\fpacket_drift\x18, \x01(\v2\x11.media_router.RTPDriftR\vpacketDrift\x12;\n" +
	"\x10ntp_report_drift\x18- \x01(\v2\x11.media_router.RTPDriftR\x0entpReportDrift\x12C\n" +
	"\x14rebased_report_drift\x18. \x01(\v2\x11.media_router.RTPDriftR\x12rebasedReportDrift\x12E\n" +
	"\x15received_report_drift\x18/ \x01(\v2\x11.media_router.RTPDriftR\x13receivedReportDrift\x1a?\n" +
	...
	"\n" +
	"rtp_munger\x18\x06 \x01(\v2\x17.media_router.RTPMungerStateR\trtpMunger\x128\n" +
	"\n" +
	"vp8_munger\x18\a \x01(\v2\x17.media_router.VP8MungerStateH\x00R\tvp8Munger\x12N\n" +
	"\x13sender_report_state\x18\b \x03(\v2\x1e.media_router.RTCPSenderReportStateR\x11senderReportStateB\x0e\n" +
	...
	"\n" +
	"TextHeader\x12H\n" +
	"\x0eoperation_type\x18\x01 \x01(\x0e2!.media_router.DataStream.OperationTypeR\roperationType\x12\x18\n" +
	...
	"\x0fencryption_type\x18\a \x01(\x0e2\x18.media_router.Encryption.TypeR\x0eencryptionType\x12J\n" +
	"\n" +
	"attributes\x18\b \x03(\v2*.media_router.DataStream.Header.AttributesEntryR\n" +
	"attributes\x12A\n" +
	"\vtext_header\x18\t \x01(\v2\x1e.media_router.DataStream.TextHeaderH\x00R\n" +
	"textHeader\x12A\n" +
	"\vbyte_header\x18\n" +
	" \x01(\v2\x1e.media_router.DataStream.ByteHeaderH\x00R\n" +
	"byteHeader\x1a=\n" +
	"\x0fAttributesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	...
	"\n" +
	"attributes\x18\x03 \x03(\v2+.media_router.DataStream.Trailer.AttributesEntryR\n" +
	"attributes\x1a=\n" +
	"\x0fAttributesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	...
	"\x14TF_PRECONNECT_BUFFER\x10\x06BNZ+github.com/media_routerofficial/protocol/media_router\xaa\x02\rVibTree.Proto\xea\x02\x0eVibTree::Protob\x06proto3"

var (
	file_media_router_models_proto_rawDescOnce sync.Once
	file_media_router_models_proto_rawDescData []byte
)

func file_media_router_models_proto_rawDescGZIP() []byte {
	file_media_router_models_proto_rawDescOnce.Do(func() {
		file_media_router_models_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_media_router_models_proto_rawDesc), len(file_media_router_models_proto_rawDesc)))
	})
...
var file_media_router_models_proto_goTypes = []any{
...
func file_media_router_models_proto_init() {
	...
	file_media_router_models_proto_msgTypes[11].OneofWrappers = []any{
		(*DataPacket_User)(nil),
	...
	file_media_router_models_proto_msgTypes[14].OneofWrappers = []any{}
	file_media_router_models_proto_msgTypes[18].OneofWrappers = []any{}
	file_media_router_models_proto_msgTypes[21].OneofWrappers = []any{
		(*RpcResponse_Payload)(nil),
		(*RpcResponse_Error)(nil),
	}
	file_media_router_models_proto_msgTypes[32].OneofWrappers = []any{
		(*RTPForwarderState_Vp8Munger)(nil),
	}
	file_media_router_models_proto_msgTypes[42].OneofWrappers = []any{
		(*DataStream_Header_TextHeader)(nil),
		(*DataStream_Header_ByteHeader)(nil),
	}
	file_media_router_models_proto_msgTypes[43].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_media_router_models_proto_rawDesc), len(file_media_router_models_proto_rawDesc)),
			NumEnums:      21,
			NumMessages:   47,
			NumExtensions: 0,
			NumServices:   0,
