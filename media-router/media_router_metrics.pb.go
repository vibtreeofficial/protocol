...
func (MetricLabel) Descriptor() protoreflect.EnumDescriptor {
	return file_media_router_metrics_proto_enumTypes[0].Descriptor()
}

func (MetricLabel) Type() protoreflect.EnumType {
	return &file_media_router_metrics_proto_enumTypes[0]
}
...
const file_media_router_metrics_proto_rawDesc = "" +
	"\n" +
	"\x15media_router_metrics.proto\x12\amedia_router\x1a\x1fgoogle/protobuf/timestamp.proto\"\x85\x02\n" +
	"\fMetricsBatch\x12!\n" +
	...
	"\vtime_series\x18\x04 \x03(\v2\x19.media_router.TimeSeriesMetricR\n" +
	"timeSeries\x12,\n" +
	"\x06events\x18\x05 \x03(\v2\x14.media_router.EventMetricR\x06events\"\xbb\x01\n" +
	...
	"\asamples\x18\x04 \x03(\v2\x15.media_router.MetricSampleR\asamples\x12\x10\n" +
	...
	"!METRIC_LABEL_PREDEFINED_MAX_VALUE\x10\x80 BNZ+github.com/media_routerofficial/protocol/media_router\xaa\x02\rVibTree.Proto\xea\x02\x0eVibTree::Protob\x06proto3"

var (
	file_media_router_metrics_proto_rawDescOnce sync.Once
	file_media_router_metrics_proto_rawDescData []byte
)

func file_media_router_metrics_proto_rawDescGZIP() []byte {
	file_media_router_metrics_proto_rawDescOnce.Do(func() {
		file_media_router_metrics_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_media_router_metrics_proto_rawDesc), len(file_media_router_metrics_proto_rawDesc)))
	})
	return file_media_router_metrics_proto_rawDescData
}

var file_media_router_metrics_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_media_router_metrics_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_media_router_metrics_proto_goTypes = []any{
	(MetricLabel)(0),              // 0: media_router.MetricLabel
	(*MetricsBatch)(nil),          // 1: media_router.MetricsBatch
	(*TimeSeriesMetric)(nil),      // 2: media_router.TimeSeriesMetric
	(*MetricSample)(nil),          // 3: media_router.MetricSample
	(*EventMetric)(nil),           // 4: media_router.EventMetric
	(*timestamppb.Timestamp)(nil), // 5: google.protobuf.Timestamp
}
var file_media_router_metrics_proto_depIdxs = []int32{
	5, // 0: media_router.MetricsBatch.normalized_timestamp:type_name -> google.protobuf.Timestamp
	2, // 1: media_router.MetricsBatch.time_series:type_name -> media_router.TimeSeriesMetric
	4, // 2: media_router.MetricsBatch.events:type_name -> media_router.EventMetric
	3, // 3: media_router.TimeSeriesMetric.samples:type_name -> media_router.MetricSample
	5, // 4: media_router.MetricSample.normalized_timestamp:type_name -> google.protobuf.Timestamp
	5, // 5: media_router.EventMetric.normalized_start_timestamp:type_name -> google.protobuf.Timestamp
	5, // 6: media_router.EventMetric.normalized_end_timestamp:type_name -> google.protobuf.Timestamp
...
func file_media_router_metrics_proto_init() {
	...
	file_media_router_metrics_proto_msgTypes[3].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_media_router_metrics_proto_rawDesc), len(file_media_router_metrics_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		...
		EnumInfos:         file_media_router_metrics_proto_enumTypes,
