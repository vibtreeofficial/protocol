...
const file_media_router_rtc_proto_rawDesc = "" +
	"\n" +
	"\x11media_router_rtc.proto\x12\amedia_router\x1a\x14media_router_models.proto\"\x9e\b\n" +
	"\rSignalRequest\x123\n" +
	"\x05offer\x18\x01 \x01(\v2\x1b.media_router.SessionDescriptionH\x00R\x05offer\x125\n" +
	"\x06answer\x18\x02 \x01(\v2\x1b.media_router.SessionDescriptionH\x00R\x06answer\x123\n" +
	"\atrickle\x18\x03 \x01(\v2\x17.media_router.TrickleRequestH\x00R\atrickle\x127\n" +
	"\tadd_track\x18\x04 \x01(\v2\x18.media_router.AddTrackRequestH\x00R\baddTrack\x12/\n" +
	"\x04mute\x18\x05 \x01(\v2\x19.media_router.MuteTrackRequestH\x00R\x04mute\x12A\n" +
	"\fsubscription\x18\x06 \x01(\v2\x1b.media_router.UpdateSubscriptionH\x00R\fsubscription\x12C\n" +
	"\rtrack_setting\x18\a \x01(\v2\x1c.media_router.UpdateTrackSettingsH\x00R\ftrackSetting\x12-\n" +
	"\x05leave\x18\b \x01(\v2\x15.media_router.LeaveRequestH\x00R\x05leave\x12E\n" +
	"\rupdate_layers\x18\n" +
	" \x01(\v2\x1a.media_router.UpdateVideoLayersB\x02\x18\x01H\x00R\fupdateLayers\x12Z\n" +
	"\x17subscription_permission\x18\v \x01(\v2\x1f.media_router.SubscriptionPermissionH\x00R\x16subscriptionPermission\x123\n" +
	"\n" +
	"sync_state\x18\f \x01(\v2\x12.media_router.SyncStateH\x00R\tsyncState\x127\n" +
	"\bsimulate\x18\r \x01(\v2\x19.media_router.SimulateScenarioH\x00R\bsimulate\x12\x14\n" +
	"\x04ping\x18\x0e \x01(\x03H\x00R\x04ping\x12M\n" +
	"\x0fupdate_metadata\x18\x0f \x01(\v2\".media_router.UpdateParticipantMetadataH\x00R\x0eupdateMetadata\x12*\n" +
	"\bping_req\x18\x10 \x01(\v2\r.media_router.PingH\x00R\apingReq\x12N\n" +
	"\x12update_audio_track\x18\x11 \x01(\v2\x1e.media_router.UpdateLocalAudioTrackH\x00R\x10updateAudioTrack\x12N\n" +
	"\x12update_video_track\x18\x12 \x01(\v2\x1e.media_router.UpdateLocalVideoTrackH\x00R\x10updateVideoTrackB\t\n" +
	"\amessage\"\xd4\v\n" +
	"\x0eSignalResponse\x12+\n" +
	"\x04join\x18\x01 \x01(\v2\x15.media_router.JoinResponseH\x00R\x04join\x125\n" +
	"\x06answer\x18\x02 \x01(\v2\x1b.media_router.SessionDescriptionH\x00R\x06answer\x123\n" +
	"\x05offer\x18\x03 \x01(\v2\x1b.media_router.SessionDescriptionH\x00R\x05offer\x123\n" +
	"\atrickle\x18\x04 \x01(\v2\x17.media_router.TrickleRequestH\x00R\atrickle\x124\n" +
	"\x06update\x18\x05 \x01(\v2\x1a.media_router.ParticipantUpdateH\x00R\x06update\x12J\n" +
	"\x0ftrack_published\x18\x06 \x01(\v2\x1f.media_router.TrackPublishedResponseH\x00R\x0etrackPublished\x12-\n" +
	"\x05leave\x18\b \x01(\v2\x15.media_router.LeaveRequestH\x00R\x05leave\x12/\n" +
	"\x04mute\x18\t \x01(\v2\x19.media_router.MuteTrackRequestH\x00R\x04mute\x12E\n" +
	"\x10speakers_changed\x18\n" +
	" \x01(\v2\x18.media_router.SpeakersChangedH\x00R\x0fspeakersChanged\x126\n" +
	"\vroom_update\x18\v \x01(\v2\x13.media_router.RoomUpdateH\x00R\n" +
	"roomUpdate\x12Q\n" +
	"\x12connection_quality\x18\f \x01(\v2 .media_router.ConnectionQualityUpdateH\x00R\x11connectionQuality\x12L\n" +
	"\x13stream_state_update\x18\r \x01(\v2\x1a.media_router.StreamStateUpdateH\x00R\x11streamStateUpdate\x12^\n" +
	"\x19subscribed_quality_update\x18\x0e \x01(\v2 .media_router.SubscribedQualityUpdateH\x00R\x17subscribedQualityUpdate\x12m\n" +
	"\x1esubscription_permission_update\x18\x0f \x01(\v2%.media_router.SubscriptionPermissionUpdateH\x00R\x1csubscriptionPermissionUpdate\x12%\n" +
	"\rrefresh_token\x18\x10 \x01(\tH\x00R\frefreshToken\x12P\n" +
	"\x11track_unpublished\x18\x11 \x01(\v2!.media_router.TrackUnpublishedResponseH\x00R\x10trackUnpublished\x12\x14\n" +
	"\x04pong\x18\x12 \x01(\x03H\x00R\x04pong\x12:\n" +
	"\treconnect\x18\x13 \x01(\v2\x1a.media_router.ReconnectResponseH\x00R\treconnect\x12,\n" +
	"\tpong_resp\x18\x14 \x01(\v2\r.media_router.PongH\x00R\bpongResp\x12T\n" +
	"\x15subscription_response\x18\x15 \x01(\v2\x1d.media_router.SubscriptionResponseH\x00R\x14subscriptionResponse\x12E\n" +
	"\x10request_response\x18\x16 \x01(\v2\x18.media_router.RequestResponseH\x00R\x0frequestResponse\x12E\n" +
	"\x10track_subscribed\x18\x17 \x01(\v2\x18.media_router.TrackSubscribedH\x00R\x0ftrackSubscribed\x12;\n" +
	"\n" +
	"room_moved\x18\x18 \x01(\v2\x1a.media_router.RoomMovedResponseH\x00R\troomMovedB\t\n" +
	"\amessage\"8\n" +
	...
	"\x04type\x18\x03 \x01(\x0e2\x12.media_router.TrackTypeR\x04type\x12\x14\n" +
	...
	"disableDtx\x12,\n" +
	"\x06source\x18\b \x01(\x0e2\x14.media_router.TrackSourceR\x06source\x12+\n" +
	"\x06layers\x18\t \x03(\v2\x13.media_router.VideoLayerR\x06layers\x12B\n" +
	"\x10simulcast_codecs\x18\n" +
	" \x03(\v2\x17.media_router.SimulcastCodecR\x0fsimulcastCodecs\x12\x10\n" +
	"\x03sid\x18\v \x01(\tR\x03sid\x12\x1a\n" +
	"\x06stereo\x18\f \x01(\bB\x02\x18\x01R\x06stereo\x12\x1f\n" +
	"\vdisable_red\x18\r \x01(\bR\n" +
	"disableRed\x128\n" +
	"\n" +
	"encryption\x18\x0e \x01(\x0e2\x18.media_router.Encryption.TypeR\n" +
	"encryption\x12\x16\n" +
	"\x06stream\x18\x0f \x01(\tR\x06stream\x12J\n" +
	"\x13backup_codec_policy\x18\x10 \x01(\x0e2\x1a.media_router.BackupCodecPolicyR\x11backupCodecPolicy\x12A\n" +
	"\x0eaudio_features\x18\x11 \x03(\x0e2\x1a.media_router.AudioTrackFeatureR\raudioFeatures\"{\n" +
	"\x0eTrickleRequest\x12$\n" +
	"\rcandidateInit\x18\x01 \x01(\tR\rcandidateInit\x12-\n" +
	"\x06target\x18\x02 \x01(\x0e2\x15.media_router.SignalTargetR\x06target\x12\x14\n" +
	...
	"\fJoinResponse\x12!\n" +
	"\x04room\x18\x01 \x01(\v2\r.media_router.RoomR\x04room\x12:\n" +
	"\vparticipant\x18\x02 \x01(\v2\x18.media_router.ParticipantInfoR\vparticipant\x12G\n" +
	"\x12other_participants\x18\x03 \x03(\v2\x18.media_router.ParticipantInfoR\x11otherParticipants\x12%\n" +
	"\x0eserver_version\x18\x04 \x01(\tR\rserverVersion\x123\n" +
	"\vice_servers\x18\x05 \x03(\v2\x12.media_router.ICEServerR\n" +
	"iceServers\x12-\n" +
	"\x12subscriber_primary\x18\x06 \x01(\bR\x11subscriberPrimary\x12'\n" +
	"\x0falternative_url\x18\a \x01(\tR\x0ealternativeUrl\x12O\n" +
	"\x14client_configuration\x18\b \x01(\v2\x1c.media_router.ClientConfigurationR\x13clientConfiguration\x12#\n" +
	"\rserver_region\x18\t \x01(\tR\fserverRegion\x12!\n" +
	"\fping_timeout\x18\n" +
	" \x01(\x05R\vpingTimeout\x12#\n" +
	"\rping_interval\x18\v \x01(\x05R\fpingInterval\x124\n" +
	"\vserver_info\x18\f \x01(\v2\x13.media_router.ServerInfoR\n" +
	"serverInfo\x12\x1f\n" +
	"\vsif_trailer\x18\r \x01(\fR\n" +
	"sifTrailer\x12D\n" +
	"\x16enabled_publish_codecs\x18\x0e \x03(\v2\x0e.media_router.CodecR\x14enabledPublishCodecs\x12!\n" +
	"\ffast_publish\x18\x0f \x01(\bR\vfastPublish\"\xf9\x01\n" +
	"\x11ReconnectResponse\x123\n" +
	"\vice_servers\x18\x01 \x03(\v2\x12.media_router.ICEServerR\n" +
	"iceServers\x12O\n" +
	"\x14client_configuration\x18\x02 \x01(\v2\x1c.media_router.ClientConfigurationR\x13clientConfiguration\x124\n" +
	"\vserver_info\x18\x03 \x01(\v2\x13.media_router.ServerInfoR\n" +
	"serverInfo\x12(\n" +
	"\x10last_message_seq\x18\x04 \x01(\rR\x0elastMessageSeq\"T\n" +
	"\x16TrackPublishedResponse\x12\x10\n" +
	"\x03cid\x18\x01 \x01(\tR\x03cid\x12(\n" +
	"\x05track\x18\x02 \x01(\v2\x12.media_router.TrackInfoR\x05track\"7\n" +
	...
	"\fparticipants\x18\x01 \x03(\v2\x18.media_router.ParticipantInfoR\fparticipants\"\x9c\x01\n" +
	"\x12UpdateSubscription\x12\x1d\n" +
	"\n" +
	"track_sids\x18\x01 \x03(\tR\ttrackSids\x12\x1c\n" +
	"\tsubscribe\x18\x02 \x01(\bR\tsubscribe\x12I\n" +
	"\x12participant_tracks\x18\x03 \x03(\v2\x1a.media_router.ParticipantTracksR\x11participantTracks\"\xdd\x01\n" +
	"\x13UpdateTrackSettings\x12\x1d\n" +
	"\n" +
	"track_sids\x18\x01 \x03(\tR\ttrackSids\x12\x1a\n" +
	"\bdisabled\x18\x03 \x01(\bR\bdisabled\x12/\n" +
	"\aquality\x18\x04 \x01(\x0e2\x15.media_router.VideoQualityR\aquality\x12\x14\n" +
	...
	"\bfeatures\x18\x02 \x03(\x0e2\x1a.media_router.AudioTrackFeatureR\bfeatures\"b\n" +
	...
	"\x06reason\x18\x02 \x01(\x0e2\x19.media_router.DisconnectReasonR\x06reason\x124\n" +
	"\x06action\x18\x03 \x01(\x0e2\x1c.media_router.LeaveRequest.ActionR\x06action\x121\n" +
	"\aregions\x18\x04 \x01(\v2\x17.media_router.RegionSettingsR\aregions\"3\n" +
	"\x06Action\x12\x0e\n" +
	"\n" +
	...
	"\x06layers\x18\x02 \x03(\v2\x13.media_router.VideoLayerR\x06layers:\x02\x18\x01\"\xfd\x01\n" +
	"\x19UpdateParticipantMetadata\x12\x1a\n" +
	"\bmetadata\x18\x01 \x01(\tR\bmetadata\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12R\n" +
	"\n" +
	"attributes\x18\x03 \x03(\v22.media_router.UpdateParticipantMetadata.AttributesEntryR\n" +
	"attributes\x12\x1d\n" +
	"\n" +
	...
	"\bspeakers\x18\x01 \x03(\v2\x14.media_router.SpeakerInfoR\bspeakers\"/\n" +
	"\n" +
	"RoomUpdate\x12!\n" +
	"\x04room\x18\x01 \x01(\v2\r.media_router.RoomR\x04room\"\x8c\x01\n" +
	"\x15ConnectionQualityInfo\x12'\n" +
	"\x0fparticipant_sid\x18\x01 \x01(\tR\x0eparticipantSid\x124\n" +
	"\aquality\x18\x02 \x01(\x0e2\x1a.media_router.ConnectionQualityR\aquality\x12\x14\n" +
	"\x05score\x18\x03 \x01(\x02R\x05score\"S\n" +
	"\x17ConnectionQualityUpdate\x128\n" +
	"\aupdates\x18\x01 \x03(\v2\x1e.media_router.ConnectionQualityInfoR\aupdates\"\x83\x01\n" +
	"\x0fStreamStateInfo\x12'\n" +
	"\x0fparticipant_sid\x18\x01 \x01(\tR\x0eparticipantSid\x12\x1b\n" +
	"\ttrack_sid\x18\x02 \x01(\tR\btrackSid\x12*\n" +
	"\x05state\x18\x03 \x01(\x0e2\x14.media_router.StreamStateR\x05state\"R\n" +
	"\x11StreamStateUpdate\x12=\n" +
	"\rstream_states\x18\x01 \x03(\v2\x18.media_router.StreamStateInfoR\fstreamStates\"^\n" +
	"\x11SubscribedQuality\x12/\n" +
	"\aquality\x18\x01 \x01(\x0e2\x15.media_router.VideoQualityR\aquality\x12\x18\n" +
	"\aenabled\x18\x02 \x01(\bR\aenabled\"a\n" +
	"\x0fSubscribedCodec\x12\x14\n" +
	"\x05codec\x18\x01 \x01(\tR\x05codec\x128\n" +
	"\tqualities\x18\x02 \x03(\v2\x1a.media_router.SubscribedQualityR\tqualities\"\xd0\x01\n" +
	"\x17SubscribedQualityUpdate\x12\x1b\n" +
	"\ttrack_sid\x18\x01 \x01(\tR\btrackSid\x12Q\n" +
	"\x14subscribed_qualities\x18\x02 \x03(\v2\x1a.media_router.SubscribedQualityB\x02\x18\x01R\x13subscribedQualities\x12E\n" +
	"\x11subscribed_codecs\x18\x03 \x03(\v2\x18.media_router.SubscribedCodecR\x10subscribedCodecs\"\xab\x01\n" +
	...
	"\x11track_permissions\x18\x02 \x03(\v2\x18.media_router.TrackPermissionR\x10trackPermissions\"~\n" +
	...
	"\x04room\x18\x01 \x01(\v2\r.media_router.RoomR\x04room\x12\x14\n" +
	"\x05token\x18\x02 \x01(\tR\x05token\x12:\n" +
	"\vparticipant\x18\x03 \x01(\v2\x18.media_router.ParticipantInfoR\vparticipant\x12G\n" +
	"\x12other_participants\x18\x04 \x03(\v2\x18.media_router.ParticipantInfoR\x11otherParticipants\"\xcb\x03\n" +
	"\tSyncState\x123\n" +
	"\x06answer\x18\x01 \x01(\v2\x1b.media_router.SessionDescriptionR\x06answer\x12?\n" +
	"\fsubscription\x18\x02 \x01(\v2\x1b.media_router.UpdateSubscriptionR\fsubscription\x12F\n" +
	"\x0epublish_tracks\x18\x03 \x03(\v2\x1f.media_router.TrackPublishedResponseR\rpublishTracks\x12=\n" +
	"\rdata_channels\x18\x04 \x03(\v2\x18.media_router.DataChannelInfoR\fdataChannels\x121\n" +
	"\x05offer\x18\x05 \x01(\v2\x1b.media_router.SessionDescriptionR\x05offer\x12.\n" +
	"\x13track_sids_disabled\x18\x06 \x03(\tR\x11trackSidsDisabled\x12^\n" +
	"\x1adatachannel_receive_states\x18\a \x03(\v2 .media_router.DataChannelReceiveStateR\x18datachannelReceiveStates\"Y\n" +
	...
	"\x06target\x18\x03 \x01(\x0e2\x15.media_router.SignalTargetR\x06target\"\x9b\x04\n" +
	...
	"\x19switch_candidate_protocol\x18\x05 \x01(\x0e2\x1a.media_router.CandidateProtocolH\x00R\x17switchCandidateProtocol\x123\n" +
	...
	"\aregions\x18\x01 \x03(\v2\x13.media_router.RegionInfoR\aregions\"R\n" +
	"\n" +
	"RegionInfo\x12\x16\n" +
	...
	"\ttrack_sid\x18\x01 \x01(\tR\btrackSid\x12,\n" +
	"\x03err\x18\x02 \x01(\x0e2\x1a.media_router.SubscriptionErrorR\x03err\"\xc9\x01\n" +
	"\x0fRequestResponse\x12\x1d\n" +
	"\n" +
	"request_id\x18\x01 \x01(\rR\trequestId\x127\n" +
	"\x06reason\x18\x02 \x01(\x0e2\x1f.media_router.RequestResponse.ReasonR\x06reason\x12\x18\n" +
	...
	"\vJoinRequest\x124\n" +
	"\vclient_info\x18\x01 \x01(\v2\x13.media_router.ClientInfoR\n" +
	"clientInfo\x12L\n" +
	"\x13connection_settings\x18\x02 \x01(\v2\x1b.media_router.ConnectionSettingsR\x12connectionSettings\x12\x1a\n" +
	"\bmetadata\x18\x03 \x01(\tR\bmetadata\x12f\n" +
	"\x16participant_attributes\x18\x04 \x03(\v2/.media_router.JoinRequest.ParticipantAttributesEntryR\x15participantAttributes\x12F\n" +
	"\x12add_track_requests\x18\x05 \x03(\v2\x18.media_router.AddTrackRequestR\x10addTrackRequests\x12D\n" +
	"\x0fpublisher_offer\x18\x06 \x01(\v2\x1b.media_router.SessionDescriptionR\x0epublisherOffer\x12\x1c\n" +
	"\treconnect\x18\a \x01(\bR\treconnect\x12C\n" +
	"\x10reconnect_reason\x18\b \x01(\x0e2\x18.media_router.ReconnectReasonR\x0freconnectReason\x12'\n" +
	...
	"\x03TLS\x10\x02BNZ+github.com/media_routerofficial/protocol/media_router\xaa\x02\rVibTree.Proto\xea\x02\x0eVibTree::Protob\x06proto3"

var (
	file_media_router_rtc_proto_rawDescOnce sync.Once
	file_media_router_rtc_proto_rawDescData []byte
)

func file_media_router_rtc_proto_rawDescGZIP() []byte {
	file_media_router_rtc_proto_rawDescOnce.Do(func() {
		file_media_router_rtc_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_media_router_rtc_proto_rawDesc), len(file_media_router_rtc_proto_rawDesc)))
	})
...
var file_media_router_rtc_proto_goTypes = []any{
...
func file_media_router_rtc_proto_init() {
	...
	file_media_router_rtc_proto_msgTypes[0].OneofWrappers = []any{
	...
	file_media_router_rtc_proto_msgTypes[1].OneofWrappers = []any{
	...
	file_media_router_rtc_proto_msgTypes[36].OneofWrappers = []any{
	...
	file_media_router_rtc_proto_msgTypes[44].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_media_router_rtc_proto_rawDesc), len(file_media_router_rtc_proto_rawDesc)),
			NumEnums:      5,
			NumMessages:   48,
			NumExtensions: 0,
			NumServices:   0,
