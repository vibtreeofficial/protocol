...
const file_media_router_analytics_proto_rawDesc = "" +
	"\n" +
	"\x17media_router_analytics.proto\x12\amedia_router\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x14media_router_models.proto\x1a\x14media_router_egress.proto\x1a\x15media_router_ingress.proto\x1a\x11media_router_sip.proto\x1a\x12media_router_room.proto\"s\n" +
	...
	"\fvideo_layers\x18\x0f \x03(\v2\x1c.media_router.AnalyticsVideoLayerR\vvideoLayers\x129\n" +
	"\n" +
	...
	"\x04kind\x18\x02 \x01(\x0e2\x13.media_router.StreamTypeR\x04kind\x129\n" +
	"\n" +
	...
	"\astreams\x18\n" +
	" \x03(\v2\x18.media_router.AnalyticsStreamR\astreams\x12\x12\n" +
	...
	"\x05stats\x18\x01 \x03(\v2\x16.media_router.AnalyticsStatR\x05stats\"\x82\x03\n" +
	...
	"\x10reconnect_reason\x18\x06 \x01(\x0e2\x18.media_router.ReconnectReasonR\x0freconnectReason\x12\x1e\n" +
	...
	"\x04type\x18\x01 \x01(\x0e2\x1b.media_router.AnalyticsEventTypeR\x04type\x128\n" +
	"\ttimestamp\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\ttimestamp\x12\x17\n" +
	"\aroom_id\x18\x03 \x01(\tR\x06roomId\x12!\n" +
	"\x04room\x18\x04 \x01(\v2\r.media_router.RoomR\x04room\x12%\n" +
	"\x0eparticipant_id\x18\x05 \x01(\tR\rparticipantId\x12:\n" +
	"\vparticipant\x18\x06 \x01(\v2\x18.media_router.ParticipantInfoR\vparticipant\x12\x19\n" +
	"\btrack_id\x18\a \x01(\tR\atrackId\x12(\n" +
	"\x05track\x18\b \x01(\v2\x12.media_router.TrackInfoR\x05track\x12#\n" +
	"\ranalytics_key\x18\n" +
	" \x01(\tR\fanalyticsKey\x124\n" +
	"\vclient_info\x18\v \x01(\v2\x13.media_router.ClientInfoR\n" +
	"clientInfo\x12=\n" +
	"\vclient_meta\x18\f \x01(\v2\x1c.media_router.AnalyticsClientMetaR\n" +
	"clientMeta\x12\x1b\n" +
	"\tegress_id\x18\r \x01(\tR\begressId\x12\x1d\n" +
	"\n" +
	"ingress_id\x18\x13 \x01(\tR\tingressId\x12V\n" +
	"\x1cmax_subscribed_video_quality\x18\x0e \x01(\x0e2\x15.media_router.VideoQualityR\x19maxSubscribedVideoQuality\x126\n" +
	"\tpublisher\x18\x0f \x01(\v2\x18.media_router.ParticipantInfoR\tpublisher\x12\x12\n" +
	"\x04mime\x18\x10 \x01(\tR\x04mime\x12+\n" +
	"\x06egress\x18\x11 \x01(\v2\x13.media_router.EgressInfoR\x06egress\x12.\n" +
	"\aingress\x18\x12 \x01(\v2\x14.media_router.IngressInfoR\aingress\x12\x14\n" +
	"\x05error\x18\x14 \x01(\tR\x05error\x12.\n" +
	"\trtp_stats\x18\x15 \x01(\v2\x11.media_router.RTPStatsR\brtpStats\x12\x1f\n" +
	"\vvideo_layer\x18\x16 \x01(\x05R\n" +
	"videoLayer\x12\x17\n" +
	"\anode_id\x18\x18 \x01(\tR\x06nodeId\x12\x1e\n" +
	"\vsip_call_id\x18\x1a \x01(\tR\tsipCallId\x12/\n" +
	"\bsip_call\x18\x1b \x01(\v2\x14.media_router.SIPCallInfoR\asipCall\x12 \n" +
	"\fsip_trunk_id\x18\x1c \x01(\tR\n" +
	"sipTrunkId\x12H\n" +
	"\x11sip_inbound_trunk\x18\x1d \x01(\v2\x1c.media_router.SIPInboundTrunkInfoR\x0fsipInboundTrunk\x12K\n" +
	"\x12sip_outbound_trunk\x18\x1e \x01(\v2\x1d.media_router.SIPOutboundTrunkInfoR\x10sipOutboundTrunk\x12/\n" +
	"\x14sip_dispatch_rule_id\x18\x1f \x01(\tR\x11sipDispatchRuleId\x12H\n" +
	"\x11sip_dispatch_rule\x18  \x01(\v2\x1c.media_router.SIPDispatchRuleInfoR\x0fsipDispatchRule\x12;\n" +
	"\fsip_transfer\x18$ \x01(\v2\x18.media_router.SIPTransferInfoR\vsipTransfer\x12+\n" +
	"\x06report\x18! \x01(\v2\x13.media_router.ReportInfoR\x06report\x12/\n" +
	"\bapi_call\x18\" \x01(\v2\x14.media_router.APICallInfoR\aapiCall\x12.\n" +
	"\awebhook\x18# \x01(\v2\x14.media_router.WebhookInfoR\awebhook\"B\n" +
	"\x0fAnalyticsEvents\x12/\n" +
	"\x06events\x18\x01 \x03(\v2\x17.media_router.AnalyticsEventR\x06events\"\xc9\x01\n" +
	"\x18AnalyticsRoomParticipant\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x1a\n" +
	"\bidentity\x18\x02 \x01(\tR\bidentity\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name\x124\n" +
	"\x05state\x18\x04 \x01(\x0e2\x1e.media_router.ParticipantInfo.StateR\x05state\x127\n" +
	...
	"\fparticipants\x18\x04 \x03(\v2!.media_router.AnalyticsRoomParticipantR\fparticipants\"\xbe\x01\n" +
	"\x12AnalyticsNodeRooms\x12\x17\n" +
	"\anode_id\x18\x01 \x01(\tR\x06nodeId\x12'\n" +
	"\x0fsequence_number\x18\x02 \x01(\x04R\x0esequenceNumber\x128\n" +
	"\ttimestamp\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\ttimestamp\x12,\n" +
	"\x05rooms\x18\x04 \x03(\v2\x16.media_router.AnalyticsRoomR\x05rooms\"Y\n" +
	"\n" +
	"ReportInfo\x12@\n" +
	"\rfeature_usage\x18\x01 \x01(\v2\x19.media_router.FeatureUsageInfoH\x00R\ffeatureUsageB\t\n" +
	"\amessage\"}\n" +
	"\tTimeRange\x129\n" +
	"\n" +
	...
	"\afeature\x18\x01 \x01(\x0e2!.media_router.FeatureUsageInfo.FeatureR\afeature\x12\x1d\n" +
	"\n" +
	...
	"\vtime_ranges\x18\b \x03(\v2\x12.media_router.TimeRangeR\n" +
	"timeRanges\"P\n" +
	"\aFeature\x12\x1c\n" +
	"\x18KRISP_NOISE_CANCELLATION\x10\x00\x12'\n" +
	"#KRISP_BACKGROUND_VOICE_CANCELLATION\x10\x01\"\x95\a\n" +
	"\x0eAPICallRequest\x12L\n" +
	"\x13create_room_request\x18\x01 \x01(\v2\x1a.media_router.CreateRoomRequestH\x00R\x11createRoomRequest\x12I\n" +
	"\x12list_rooms_request\x18\x02 \x01(\v2\x19.media_router.ListRoomsRequestH\x00R\x10listRoomsRequest\x12L\n" +
	"\x13delete_room_request\x18\x03 \x01(\v2\x1a.media_router.DeleteRoomRequestH\x00R\x11deleteRoomRequest\x12^\n" +
	"\x19list_participants_request\x18\x04 \x01(\v2 .media_router.ListParticipantsRequestH\x00R\x17listParticipantsRequest\x12^\n" +
	"\x19room_participant_identity\x18\x05 \x01(\v2 .media_router.RoomParticipantIdentityH\x00R\x17roomParticipantIdentity\x12V\n" +
	"\x17mute_room_track_request\x18\x06 \x01(\v2\x1d.media_router.MuteRoomTrackRequestH\x00R\x14muteRoomTrackRequest\x12a\n" +
	"\x1aupdate_participant_request\x18\a \x01(\v2!.media_router.UpdateParticipantRequestH\x00R\x18updateParticipantRequest\x12g\n" +
	"\x1cupdate_subscriptions_request\x18\b \x01(\v2#.media_router.UpdateSubscriptionsRequestH\x00R\x1aupdateSubscriptionsRequest\x12F\n" +
	"\x11send_data_request\x18\t \x01(\v2\x18.media_router.SendDataRequestH\x00R\x0fsendDataRequest\x12e\n" +
	"\x1cupdate_room_metadata_request\x18\n" +
	" \x01(\v2\".media_router.UpdateRoomMetadataRequestH\x00R\x19updateRoomMetadataRequestB\t\n" +
	"\amessage\"\xa3\x04\n" +
	"\vAPICallInfo\x12\x1d\n" +
	"\n" +
	"project_id\x18\x01 \x01(\tR\tprojectId\x121\n" +
	"\arequest\x18\x02 \x01(\v2\x17.media_router.APICallRequestR\arequest\x12\x18\n" +
	...
	"\x06REPORT\x10(\x12\f\n" +
	"\bAPI_CALL\x10)\x12\v\n" +
	"\aWEBHOOK\x10*BNZ+github.com/media_routerofficial/protocol/media_router\xaa\x02\rVibTree.Proto\xea\x02\x0eVibTree::Protob\x06proto3"

var (
	file_media_router_analytics_proto_rawDescOnce sync.Once
	file_media_router_analytics_proto_rawDescData []byte
)

func file_media_router_analytics_proto_rawDescGZIP() []byte {
	file_media_router_analytics_proto_rawDescOnce.Do(func() {
		file_media_router_analytics_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_media_router_analytics_proto_rawDesc), len(file_media_router_analytics_proto_rawDesc)))
	})
...
var file_media_router_analytics_proto_goTypes = []any{
...
func file_media_router_analytics_proto_init() {
	...
	file_media_router_analytics_proto_msgTypes[4].OneofWrappers = []any{}
	file_media_router_analytics_proto_msgTypes[10].OneofWrappers = []any{
		(*ReportInfo_FeatureUsage)(nil),
	}
	file_media_router_analytics_proto_msgTypes[13].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_media_router_analytics_proto_rawDesc), len(file_media_router_analytics_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   16,
			NumExtensions: 0,
			NumServices:   0,
