...
const file_media_router_sip_proto_rawDesc = "" +
	"\n" +
	"\x11media_router_sip.proto\x12\amedia_router\x1a\x1egoogle/protobuf/duration.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x14media_router_models.proto\x1a\x12media_router_room.proto\"O\n" +
	"\tSIPStatus\x12*\n" +
	"\x04code\x18\x01 \x01(\x0e2\x16.media_router.SIPStatusCodeR\x04code\x12\x16\n" +
	...
	"sipTrunkId\x123\n" +
	"\x04kind\x18\x0e \x01(\x0e2\x1f.media_router.SIPTrunkInfo.TrunkKindR\x04kind\x12+\n" +
	...
	"\ttransport\x18\r \x01(\x0e2\x15.media_router.SIPTransportR\ttransport\x126\n" +
	...
	"\x05trunk\x18\x01 \x01(\v2\x1c.media_router.SIPInboundTrunkInfoR\x05trunk\"\xbe\x01\n" +
	"\x1cUpdateSIPInboundTrunkRequest\x12 \n" +
	"\fsip_trunk_id\x18\x01 \x01(\tR\n" +
	"sipTrunkId\x128\n" +
	"\areplace\x18\x02 \x01(\v2\x1c.media_router.SIPInboundTrunkInfoH\x00R\areplace\x128\n" +
	"\x06update\x18\x03 \x01(\v2\x1e.media_router.SIPInboundTrunkUpdateH\x00R\x06updateB\b\n" +
	"\x06action\"\xc4\b\n" +
	...
	"\aheaders\x18\t \x03(\v2).media_router.SIPInboundTrunkInfo.HeadersEntryR\aheaders\x12i\n" +
	"\x15headers_to_attributes\x18\n" +
	" \x03(\v25.media_router.SIPInboundTrunkInfo.HeadersToAttributesEntryR\x13headersToAttributes\x12i\n" +
	"\x15attributes_to_headers\x18\x0e \x03(\v25.media_router.SIPInboundTrunkInfo.AttributesToHeadersEntryR\x13attributesToHeaders\x12B\n" +
	"\x0finclude_headers\x18\x0f \x01(\x0e2\x19.media_router.SIPHeaderOptionsR\x0eincludeHeaders\x12B\n" +
	...
	"\x10media_encryption\x18\x10 \x01(\x0e2\x1b.media_router.SIPMediaEncryptionR\x0fmediaEncryption\x1a:\n" +
	...
	"\anumbers\x18\x01 \x01(\v2\x13.media_router.ListUpdateR\anumbers\x12@\n" +
	"\x11allowed_addresses\x18\x02 \x01(\v2\x13.media_router.ListUpdateR\x10allowedAddresses\x12<\n" +
	"\x0fallowed_numbers\x18\x03 \x01(\v2\x13.media_router.ListUpdateR\x0eallowedNumbers\x12(\n" +
	...
	"\x10media_encryption\x18\b \x01(\x0e2\x1b.media_router.SIPMediaEncryptionH\x04R\x0fmediaEncryption\x88\x01\x01B\x10\n" +
	...
	"\x05trunk\x18\x01 \x01(\v2\x1d.media_router.SIPOutboundTrunkInfoR\x05trunk\"\xc1\x01\n" +
	"\x1dUpdateSIPOutboundTrunkRequest\x12 \n" +
	"\fsip_trunk_id\x18\x01 \x01(\tR\n" +
	"sipTrunkId\x129\n" +
	"\areplace\x18\x02 \x01(\v2\x1d.media_router.SIPOutboundTrunkInfoH\x00R\areplace\x129\n" +
	"\x06update\x18\x03 \x01(\v2\x1f.media_router.SIPOutboundTrunkUpdateH\x00R\x06updateB\b\n" +
	"\x06action\"\xc2\a\n" +
	...
	"\ttransport\x18\x05 \x01(\x0e2\x15.media_router.SIPTransportR\ttransport\x12\x18\n" +
	"\anumbers\x18\x06 \x03(\tR\anumbers\x12#\n" +
	"\rauth_username\x18\a \x01(\tR\fauthUsername\x12#\n" +
	"\rauth_password\x18\b \x01(\tR\fauthPassword\x12D\n" +
	"\aheaders\x18\t \x03(\v2*.media_router.SIPOutboundTrunkInfo.HeadersEntryR\aheaders\x12j\n" +
	"\x15headers_to_attributes\x18\n" +
	" \x03(\v26.media_router.SIPOutboundTrunkInfo.HeadersToAttributesEntryR\x13headersToAttributes\x12j\n" +
	"\x15attributes_to_headers\x18\v \x03(\v26.media_router.SIPOutboundTrunkInfo.AttributesToHeadersEntryR\x13attributesToHeaders\x12B\n" +
	"\x0finclude_headers\x18\f \x01(\x0e2\x19.media_router.SIPHeaderOptionsR\x0eincludeHeaders\x12F\n" +
	"\x10media_encryption\x18\r \x01(\x0e2\x1b.media_router.SIPMediaEncryptionR\x0fmediaEncryption\x1a:\n" +
	"\fHeadersEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\x1aF\n" +
	"\x18HeadersToAttributesEntry\x12\x10\n" +
	...
	"\ttransport\x18\x02 \x01(\x0e2\x15.media_router.SIPTransportH\x01R\ttransport\x88\x01\x01\x124\n" +
	"\x13destination_country\x18\t \x01(\tH\x02R\x12destinationCountry\x88\x01\x01\x12-\n" +
	"\anumbers\x18\x03 \x01(\v2\x13.media_router.ListUpdateR\anumbers\x12(\n" +
	...
	"\x10media_encryption\x18\b \x01(\x0e2\x1b.media_router.SIPMediaEncryptionH\aR\x0fmediaEncryption\x88\x01\x01B\n" +
	"\n" +
	"\b_addressB\f\n" +
	"\n" +
	"_transportB\x16\n" +
	...
	"\x05trunk\x18\x01 \x01(\v2\x1c.media_router.SIPInboundTrunkInfoR\x05trunk\">\n" +
	"\x1aGetSIPOutboundTrunkRequest\x12 \n" +
	"\fsip_trunk_id\x18\x01 \x01(\tR\n" +
	"sipTrunkId\"R\n" +
	"\x1bGetSIPOutboundTrunkResponse\x123\n" +
	"\x05trunk\x18\x01 \x01(\v2\x1d.media_router.SIPOutboundTrunkInfoR\x05trunk\"B\n" +
	"\x13ListSIPTrunkRequest\x12'\n" +
	"\x04page\x18\x01 \x01(\v2\x13.media_router.PaginationR\x04page:\x02\x18\x01\"G\n" +
	"\x14ListSIPTrunkResponse\x12+\n" +
	"\x05items\x18\x01 \x03(\v2\x15.media_router.SIPTrunkInfoR\x05items:\x02\x18\x01\"|\n" +
	"\x1aListSIPInboundTrunkRequest\x12'\n" +
	"\x04page\x18\x03 \x01(\v2\x13.media_router.PaginationR\x04page\x12\x1b\n" +
	"\ttrunk_ids\x18\x01 \x03(\tR\btrunkIds\x12\x18\n" +
	"\anumbers\x18\x02 \x03(\tR\anumbers\"Q\n" +
	"\x1bListSIPInboundTrunkResponse\x122\n" +
	"\x05items\x18\x01 \x03(\v2\x1c.media_router.SIPInboundTrunkInfoR\x05items\"}\n" +
	"\x1bListSIPOutboundTrunkRequest\x12'\n" +
	"\x04page\x18\x03 \x01(\v2\x13.media_router.PaginationR\x04page\x12\x1b\n" +
	"\ttrunk_ids\x18\x01 \x03(\tR\btrunkIds\x12\x18\n" +
	"\anumbers\x18\x02 \x03(\tR\anumbers\"S\n" +
	"\x1cListSIPOutboundTrunkResponse\x123\n" +
	"\x05items\x18\x01 \x03(\v2\x1d.media_router.SIPOutboundTrunkInfoR\x05items\"9\n" +
	...
	"\x14dispatch_rule_direct\x18\x01 \x01(\v2\x1e.media_router.SIPDispatchRuleDirectH\x00R\x12dispatchRuleDirect\x12^\n" +
	"\x18dispatch_rule_individual\x18\x02 \x01(\v2\".media_router.SIPDispatchRuleIndividualH\x00R\x16dispatchRuleIndividual\x12R\n" +
	"\x14dispatch_rule_callee\x18\x03 \x01(\v2\x1e.media_router.SIPDispatchRuleCalleeH\x00R\x12dispatchRuleCalleeB\x06\n" +
	"\x04rule\"\xc9\x04\n" +
	"\x1cCreateSIPDispatchRuleRequest\x12A\n" +
	"\rdispatch_rule\x18\n" +
	" \x01(\v2\x1c.media_router.SIPDispatchRuleInfoR\fdispatchRule\x120\n" +
	"\x04rule\x18\x01 \x01(\v2\x18.media_router.SIPDispatchRuleB\x02\x18\x01R\x04rule\x12\x1f\n" +
	...
	"\n" +
	"attributes\x18\a \x03(\v25.media_router.CreateSIPDispatchRuleRequest.AttributesEntryB\x02\x18\x01R\n" +
	"attributes\x12#\n" +
	"\vroom_preset\x18\b \x01(\tB\x02\x18\x01R\n" +
	"roomPreset\x12?\n" +
	"\vroom_config\x18\t \x01(\v2\x1a.media_router.RoomConfigurationB\x02\x18\x01R\n" +
	"roomConfig\x1a=\n" +
	...
	"\areplace\x18\x02 \x01(\v2\x1c.media_router.SIPDispatchRuleInfoH\x00R\areplace\x128\n" +
	"\x06update\x18\x03 \x01(\v2\x1e.media_router.SIPDispatchRuleUpdateH\x00R\x06updateB\b\n" +
	"\x06action\"\xee\x04\n" +
	"\x13SIPDispatchRuleInfo\x12/\n" +
	"\x14sip_dispatch_rule_id\x18\x01 \x01(\tR\x11sipDispatchRuleId\x12,\n" +
	"\x04rule\x18\x02 \x01(\v2\x18.media_router.SIPDispatchRuleR\x04rule\x12\x1b\n" +
	...
	"\n" +
	"attributes\x18\b \x03(\v2,.media_router.SIPDispatchRuleInfo.AttributesEntryR\n" +
	"attributes\x12\x1f\n" +
	"\vroom_preset\x18\t \x01(\tR\n" +
	"roomPreset\x12;\n" +
	"\vroom_config\x18\n" +
	" \x01(\v2\x1a.media_router.RoomConfigurationR\n" +
	"roomConfig\x12#\n" +
	"\rkrisp_enabled\x18\v \x01(\bR\fkrispEnabled\x12F\n" +
	"\x10media_encryption\x18\f \x01(\x0e2\x1b.media_router.SIPMediaEncryptionR\x0fmediaEncryption\x1a=\n" +
	"\x0fAttributesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"\xb8\x03\n" +
	"\x15SIPDispatchRuleUpdate\x120\n" +
	"\ttrunk_ids\x18\x01 \x01(\v2\x13.media_router.ListUpdateR\btrunkIds\x12,\n" +
	"\x04rule\x18\x02 \x01(\v2\x18.media_router.SIPDispatchRuleR\x04rule\x12\x17\n" +
	"\x04name\x18\x03 \x01(\tH\x00R\x04name\x88\x01\x01\x12\x1f\n" +
	"\bmetadata\x18\x04 \x01(\tH\x01R\bmetadata\x88\x01\x01\x12N\n" +
	"\n" +
	"attributes\x18\x05 \x03(\v2..media_router.SIPDispatchRuleUpdate.AttributesEntryR\n" +
	"attributes\x12K\n" +
	"\x10media_encryption\x18\x06 \x01(\x0e2\x1b.media_router.SIPMediaEncryptionH\x02R\x0fmediaEncryption\x88\x01\x01\x1a=\n" +
	"\x0fAttributesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	...
	"\x04page\x18\x03 \x01(\v2\x13.media_router.PaginationR\x04page\x12*\n" +
	...
	"\x05items\x18\x01 \x03(\v2\x1c.media_router.SIPDispatchRuleInfoR\x05items\"O\n" +
	...
	"\ttransport\x18\x02 \x01(\x0e2\x15.media_router.SIPTransportR\ttransport\x12#\n" +
	"\rauth_username\x18\x03 \x01(\tR\fauthUsername\x12#\n" +
	"\rauth_password\x18\x04 \x01(\tR\fauthPassword\x12g\n" +
	"\x15headers_to_attributes\x18\x05 \x03(\v23.media_router.SIPOutboundConfig.HeadersToAttributesEntryR\x13headersToAttributes\x12g\n" +
	"\x15attributes_to_headers\x18\x06 \x03(\v23.media_router.SIPOutboundConfig.AttributesToHeadersEntryR\x13attributesToHeaders\x1aF\n" +
	"\x18HeadersToAttributesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\x1aF\n" +
	"\x18AttributesToHeadersEntry\x12\x10\n" +
	...
	"\fsip_trunk_id\x18\x01 \x01(\tR\n" +
	"sipTrunkId\x120\n" +
	"\x05trunk\x18\x14 \x01(\v2\x1a.media_router.SIPOutboundConfigR\x05trunk\x12\x1e\n" +
	...
	"\x16participant_attributes\x18\t \x03(\v2?.media_router.CreateSIPParticipantRequest.ParticipantAttributesEntryR\x15participantAttributes\x12\x12\n" +
	...
	"\aheaders\x18\x10 \x03(\v21.media_router.CreateSIPParticipantRequest.HeadersEntryR\aheaders\x12B\n" +
	"\x0finclude_headers\x18\x11 \x01(\x0e2\x19.media_router.SIPHeaderOptionsR\x0eincludeHeaders\x12B\n" +
	"\x0fringing_timeout\x18\v \x01(\v2\x19.google.protobuf.DurationR\x0eringingTimeout\x12E\n" +
	"\x11max_call_duration\x18\f \x01(\v2\x19.google.protobuf.DurationR\x0fmaxCallDuration\x12#\n" +
	"\rkrisp_enabled\x18\x0e \x01(\bR\fkrispEnabled\x12F\n" +
	"\x10media_encryption\x18\x12 \x01(\x0e2\x1b.media_router.SIPMediaEncryptionR\x0fmediaEncryption\x12.\n" +
	...
	"\aheaders\x18\x05 \x03(\v23.media_router.TransferSIPParticipantRequest.HeadersEntryR\aheaders\x12B\n" +
	...
	"\x16participant_attributes\x18\x12 \x03(\v2/.media_router.SIPCallInfo.ParticipantAttributesEntryR\x15participantAttributes\x12*\n" +
	"\bfrom_uri\x18\x06 \x01(\v2\x0f.media_router.SIPUriR\afromUri\x12&\n" +
	"\x06to_uri\x18\a \x01(\v2\x0f.media_router.SIPUriR\x05toUri\x12!\n" +
	"\n" +
	...
	"\x10enabled_features\x18\x0e \x03(\x0e2\x13.media_router.SIPFeatureR\x0fenabledFeatures\x12@\n" +
	"\x0ecall_direction\x18\x0f \x01(\x0e2\x19.media_router.SIPCallDirectionR\rcallDirection\x127\n" +
	"\vcall_status\x18\b \x01(\x0e2\x16.media_router.SIPCallStatusR\n" +
	"callStatus\x12\"\n" +
	...
	"\x11disconnect_reason\x18\f \x01(\x0e2\x19.media_router.DisconnectReasonR\x10disconnectReason\x12\x14\n" +
	"\x05error\x18\r \x01(\tR\x05error\x12<\n" +
	"\x10call_status_code\x18\x13 \x01(\v2\x12.media_router.SIPStatusR\x0ecallStatusCode\x12\x1f\n" +
	...
	"\x0ftransfer_status\x18\x06 \x01(\x0e2\x1a.media_router.SIPTransferStatusR\x0etransferStatus\x12\x14\n" +
	"\x05error\x18\a \x01(\tR\x05error\x12D\n" +
	"\x14transfer_status_code\x18\b \x01(\v2\x12.media_router.SIPStatusR\x12transferStatusCode\"\x89\x01\n" +
	"\x06SIPUri\x12\x12\n" +
	"\x04user\x18\x01 \x01(\tR\x04user\x12\x12\n" +
	"\x04host\x18\x02 \x01(\tR\x04host\x12\x0e\n" +
	"\x02ip\x18\x03 \x01(\tR\x02ip\x12\x12\n" +
	"\x04port\x18\x04 \x01(\rR\x04port\x123\n" +
	"\ttransport\x18\x05 \x01(\x0e2\x15.media_router.SIPTransportR\ttransport*\xef\f\n" +
	...
	"\x03SIP\x12P\n" +
	"\fListSIPTrunk\x12\x1c.media_router.ListSIPTrunkRequest\x1a\x1d.media_router.ListSIPTrunkResponse\"\x03\x88\x02\x01\x12\\\n" +
	"\x15CreateSIPInboundTrunk\x12%.media_router.CreateSIPInboundTrunkRequest\x1a\x1c.media_router.SIPInboundTrunkInfo\x12_\n" +
	"\x16CreateSIPOutboundTrunk\x12&.media_router.CreateSIPOutboundTrunkRequest\x1a\x1d.media_router.SIPOutboundTrunkInfo\x12\\\n" +
	"\x15UpdateSIPInboundTrunk\x12%.media_router.UpdateSIPInboundTrunkRequest\x1a\x1c.media_router.SIPInboundTrunkInfo\x12_\n" +
	"\x16UpdateSIPOutboundTrunk\x12&.media_router.UpdateSIPOutboundTrunkRequest\x1a\x1d.media_router.SIPOutboundTrunkInfo\x12]\n" +
	"\x12GetSIPInboundTrunk\x12\".media_router.GetSIPInboundTrunkRequest\x1a#.media_router.GetSIPInboundTrunkResponse\x12`\n" +
	"\x13GetSIPOutboundTrunk\x12#.media_router.GetSIPOutboundTrunkRequest\x1a$.media_router.GetSIPOutboundTrunkResponse\x12`\n" +
	"\x13ListSIPInboundTrunk\x12#.media_router.ListSIPInboundTrunkRequest\x1a$.media_router.ListSIPInboundTrunkResponse\x12c\n" +
	"\x14ListSIPOutboundTrunk\x12$.media_router.ListSIPOutboundTrunkRequest\x1a%.media_router.ListSIPOutboundTrunkResponse\x12G\n" +
	"\x0eDeleteSIPTrunk\x12\x1e.media_router.DeleteSIPTrunkRequest\x1a\x15.media_router.SIPTrunkInfo\x12\\\n" +
	"\x15CreateSIPDispatchRule\x12%.media_router.CreateSIPDispatchRuleRequest\x1a\x1c.media_router.SIPDispatchRuleInfo\x12\\\n" +
	"\x15UpdateSIPDispatchRule\x12%.media_router.UpdateSIPDispatchRuleRequest\x1a\x1c.media_router.SIPDispatchRuleInfo\x12`\n" +
	"\x13ListSIPDispatchRule\x12#.media_router.ListSIPDispatchRuleRequest\x1a$.media_router.ListSIPDispatchRuleResponse\x12\\\n" +
	"\x15DeleteSIPDispatchRule\x12%.media_router.DeleteSIPDispatchRuleRequest\x1a\x1c.media_router.SIPDispatchRuleInfo\x12Y\n" +
	"\x14CreateSIPParticipant\x12$.media_router.CreateSIPParticipantRequest\x1a\x1b.media_router.SIPParticipantInfo\x12X\n" +
	"\x16TransferSIPParticipant\x12&.media_router.TransferSIPParticipantRequest\x1a\x16.google.protobuf.EmptyBNZ+github.com/media_routerofficial/protocol/media_router\xaa\x02\rVibTree.Proto\xea\x02\x0eVibTree::Protob\x06proto3"

var (
	file_media_router_sip_proto_rawDescOnce sync.Once
	file_media_router_sip_proto_rawDescData []byte
)

func file_media_router_sip_proto_rawDescGZIP() []byte {
	file_media_router_sip_proto_rawDescOnce.Do(func() {
		file_media_router_sip_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_media_router_sip_proto_rawDesc), len(file_media_router_sip_proto_rawDesc)))
	})
...
var file_media_router_sip_proto_goTypes = []any{
...
func file_media_router_sip_proto_init() {
	...
	file_media_router_sip_proto_msgTypes[4].OneofWrappers = []any{
		(*UpdateSIPInboundTrunkRequest_Replace)(nil),
		(*UpdateSIPInboundTrunkRequest_Update)(nil),
	}
	file_media_router_sip_proto_msgTypes[6].OneofWrappers = []any{}
	file_media_router_sip_proto_msgTypes[8].OneofWrappers = []any{
		(*UpdateSIPOutboundTrunkRequest_Replace)(nil),
		(*UpdateSIPOutboundTrunkRequest_Update)(nil),
	}
	file_media_router_sip_proto_msgTypes[10].OneofWrappers = []any{}
	file_media_router_sip_proto_msgTypes[25].OneofWrappers = []any{
		(*SIPDispatchRule_DispatchRuleDirect)(nil),
		(*SIPDispatchRule_DispatchRuleIndividual)(nil),
		(*SIPDispatchRule_DispatchRuleCallee)(nil),
	}
	file_media_router_sip_proto_msgTypes[27].OneofWrappers = []any{
		(*UpdateSIPDispatchRuleRequest_Replace)(nil),
		(*UpdateSIPDispatchRuleRequest_Update)(nil),
	}
	file_media_router_sip_proto_msgTypes[29].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_media_router_sip_proto_rawDesc), len(file_media_router_sip_proto_rawDesc)),
			NumEnums:      9,
			NumMessages:   55,
			NumExtensions: 0,
			NumServices:   1,
