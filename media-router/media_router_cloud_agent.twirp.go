...
func NewCloudAgentProtobufClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) CloudAgent {
	...
	serviceURL += baseServicePath(pathPrefix, "media_router", "CloudAgent")
	urls := [11]string{
...
const CloudAgentPathPrefix = "/twirp/media_router.CloudAgent/"
...
func (s *cloudAgentServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	if pkgService != "media_router.CloudAgent" {
...
func (s *cloudAgentServer) PathPrefix() string {
	return baseServicePath(s.pathPrefix, "media_router", "CloudAgent")
}

var twirpFileDescriptor5 = []byte{
	// 1227 bytes of a gzipped FileDescriptorProto
	,
}
