...
const file_media_router_agent_dispatch_proto_rawDesc = "" +
	"\n" +
	"\x1cmedia_router_agent_dispatch.proto\x12\amedia_router\x1a\x13media_router_agent.proto\"k\n" +
	...
	"\x10agent_dispatches\x18\x01 \x03(\v2\x16.media_router.AgentDispatchR\x0fagentDispatches\"\xa1\x01\n" +
	...
	"\x05state\x18\x05 \x01(\v2\x1b.media_router.AgentDispatchStateR\x05state\"t\n" +
	"\x12AgentDispatchState\x12 \n" +
	"\x04jobs\x18\x01 \x03(\v2\f.media_router.JobR\x04jobs\x12\x1d\n" +
	"\n" +
	"created_at\x18\x02 \x01(\x03R\tcreatedAt\x12\x1d\n" +
	"\n" +
	"deleted_at\x18\x03 \x01(\x03R\tdeletedAt2\x8b\x02\n" +
	"\x14AgentDispatchService\x12M\n" +
	"\x0eCreateDispatch\x12#.media_router.CreateAgentDispatchRequest\x1a\x16.media_router.AgentDispatch\x12M\n" +
	"\x0eDeleteDispatch\x12#.media_router.DeleteAgentDispatchRequest\x1a\x16.media_router.AgentDispatch\x12U\n" +
	"\fListDispatch\x12!.media_router.ListAgentDispatchRequest\x1a\".media_router.ListAgentDispatchResponseBNZ+github.com/media_routerofficial/protocol/media_router\xaa\x02\rVibTree.Proto\xea\x02\x0eVibTree::Protob\x06proto3"

var (
	file_media_router_agent_dispatch_proto_rawDescOnce sync.Once
	file_media_router_agent_dispatch_proto_rawDescData []byte
)

func file_media_router_agent_dispatch_proto_rawDescGZIP() []byte {
	file_media_router_agent_dispatch_proto_rawDescOnce.Do(func() {
		file_media_router_agent_dispatch_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_media_router_agent_dispatch_proto_rawDesc), len(file_media_router_agent_dispatch_proto_rawDesc)))
	})
...
var file_media_router_agent_dispatch_proto_goTypes = []any{
...
func file_media_router_agent_dispatch_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_media_router_agent_dispatch_proto_rawDesc), len(file_media_router_agent_dispatch_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   1,
