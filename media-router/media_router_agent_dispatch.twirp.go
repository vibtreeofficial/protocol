...
func NewAgentDispatchServiceProtobufClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) AgentDispatchService {
	...
	serviceURL += baseServicePath(pathPrefix, "media_router", "AgentDispatchService")
	urls := [3]string{
...
const AgentDispatchServicePathPrefix = "/twirp/media_router.AgentDispatchService/"
...
func (s *agentDispatchServiceServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	if pkgService != "media_router.AgentDispatchService" {
...
func (s *agentDispatchServiceServer) PathPrefix() string {
	return baseServicePath(s.pathPrefix, "media_router", "AgentDispatchService")
}
...
var twirpFileDescriptor0 = []byte{
	...
	,
}
