...
const file_media_router_internal_proto_rawDesc = "" +
	"\n" +
	"\x16media_router_internal.proto\x12\amedia_router\x1a\x14media_router_models.proto\x1a\x14media_router_egress.proto\x1a\x1cmedia_router_agent_dispatch.proto\x1a\x12media_router_room.proto\x1a\x11media_router_rtc.proto\"\xd4\x01\n" +
	"\x04Node\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x0e\n" +
	"\x02ip\x18\x02 \x01(\tR\x02ip\x12\x19\n" +
	"\bnum_cpus\x18\x03 \x01(\rR\anumCpus\x12(\n" +
	"\x05stats\x18\x04 \x01(\v2\x12.media_router.NodeStatsR\x05stats\x12%\n" +
	"\x04type\x18\x05 \x01(\x0e2\x11.media_router.NodeTypeR\x04type\x12(\n" +
	"\x05state\x18\x06 \x01(\x0e2\x12.media_router.NodeStateR\x05state\x12\x16\n" +
	...
	"\x05rates\x182 \x03(\v2\x16.media_router.NodeStatsRateR\x05rates\"\xc8\a\n" +
	...
	"\x06client\x18\v \x01(\v2\x13.media_router.ClientInfoR\x06client\x12\x1e\n" +
	...
	"\x10reconnect_reason\x18\x11 \x01(\x0e2\x18.media_router.ReconnectReasonR\x0freconnectReason\x129\n" +
	...
	"\vcreate_room\x18\x14 \x01(\v2\x1a.media_router.CreateRoomRequestR\n" +
	"createRoom\x12F\n" +
	"\x12add_track_requests\x18\x15 \x03(\v2\x18.media_router.AddTrackRequestR\x10addTrackRequests\x12D\n" +
	"\x0fpublisher_offer\x18\x16 \x01(\v2\x1b.media_router.SessionDescriptionR\x0epublisherOfferB\x19\n" +
	"\x17_subscriber_allow_pause\"\xe7\x02\n" +
	"\fRoomInternal\x12;\n" +
	"\ftrack_egress\x18\x01 \x01(\v2\x18.media_router.AutoTrackEgressR\vtrackEgress\x12M\n" +
	"\x12participant_egress\x18\x02 \x01(\v2\x1e.media_router.AutoParticipantEgressR\x11participantEgress\x12:\n" +
	"\rplayout_delay\x18\x03 \x01(\v2\x15.media_router.PlayoutDelayR\fplayoutDelay\x12E\n" +
	"\x10agent_dispatches\x18\x05 \x03(\v2\x1a.media_router.RoomAgentDispatchR\x0fagentDispatches\x12!\n" +
	"\fsync_streams\x18\x04 \x01(\bR\vsyncStreams\x12%\n" +
	"\x0ereplay_enabled\x18\x06 \x01(\bR\rreplayEnabled\"\xa9\x01\n" +
	"\tICEConfig\x12N\n" +
	"\x15preference_subscriber\x18\x01 \x01(\x0e2\x19.media_router.ICECandidateTypeR\x14preferenceSubscriber\x12L\n" +
	"\x14preference_publisher\x18\x02 \x01(\x0e2\x19.media_router.ICECandidateTypeR\x13preferencePublisher*h\n" +
	"\bNodeType\x12\n" +
	"\n" +
	...
	"\aICT_TLS\x10\x02BNZ+github.com/media_routerofficial/protocol/media_router\xaa\x02\rVibTree.Proto\xea\x02\x0eVibTree::Protob\x06proto3"

var (
	file_media_router_internal_proto_rawDescOnce sync.Once
	file_media_router_internal_proto_rawDescData []byte
)

func file_media_router_internal_proto_rawDescGZIP() []byte {
	file_media_router_internal_proto_rawDescOnce.Do(func() {
		file_media_router_internal_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_media_router_internal_proto_rawDesc), len(file_media_router_internal_proto_rawDesc)))
	})
...
var file_media_router_internal_proto_goTypes = []any{
...
func file_media_router_internal_proto_init() {
	...
	file_media_router_internal_proto_msgTypes[3].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_media_router_internal_proto_rawDesc), len(file_media_router_internal_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
