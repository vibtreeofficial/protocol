...
const file_media_router_ingress_proto_rawDesc = "" +
	"\n" +
	"\x15media_router_ingress.proto\x12\amedia_router\x1a\x14media_router_models.proto\"\xb1\x04\n" +
	"\x14CreateIngressRequest\x124\n" +
	"\n" +
	"input_type\x18\x01 \x01(\x0e2\x15.media_router.IngressInputR\tinputType\x12\x10\n" +
	...
	"\x05audio\x18\x06 \x01(\v2\x1c.media_router.IngressAudioOptionsR\x05audio\x122\n" +
	"\x05video\x18\a \x01(\v2\x1c.media_router.IngressVideoOptionsR\x05video\x12\x1d\n" +
	...
	"\x06source\x18\x02 \x01(\x0e2\x14.media_router.TrackSourceR\x06source\x12=\n" +
	"\x06preset\x18\x03 \x01(\x0e2#.media_router.IngressAudioEncodingPresetH\x00R\x06preset\x12@\n" +
	"\aoptions\x18\x04 \x01(\v2$.media_router.IngressAudioEncodingOptionsH\x00R\aoptionsB\x12\n" +
	"\x10encoding_options\"\xec\x01\n" +
	"\x13IngressVideoOptions\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12,\n" +
	"\x06source\x18\x02 \x01(\x0e2\x14.media_router.TrackSourceR\x06source\x12=\n" +
	"\x06preset\x18\x03 \x01(\x0e2#.media_router.IngressVideoEncodingPresetH\x00R\x06preset\x12@\n" +
	"\aoptions\x18\x04 \x01(\v2$.media_router.IngressVideoEncodingOptionsH\x00R\aoptionsB\x12\n" +
	"\x10encoding_options\"\xaa\x01\n" +
	"\x1bIngressAudioEncodingOptions\x124\n" +
	"\vaudio_codec\x18\x01 \x01(\x0e2\x13.media_router.AudioCodecR\n" +
	"audioCodec\x12\x18\n" +
	...
	"\vvideo_codec\x18\x01 \x01(\x0e2\x13.media_router.VideoCodecR\n" +
	"videoCodec\x12\x1d\n" +
	"\n" +
	"frame_rate\x18\x02 \x01(\x01R\tframeRate\x12+\n" +
	"\x06layers\x18\x03 \x03(\v2\x13.media_router.VideoLayerR\x06layers\"\xaf\x05\n" +
	...
	"\n" +
	"input_type\x18\x05 \x01(\x0e2\x15.media_router.IngressInputR\tinputType\x121\n" +
	...
	"\x05audio\x18\x06 \x01(\v2\x1c.media_router.IngressAudioOptionsR\x05audio\x122\n" +
	"\x05video\x18\a \x01(\v2\x1c.media_router.IngressVideoOptionsR\x05video\x12\x1b\n" +
	...
	"\x05state\x18\f \x01(\v2\x15.media_router.IngressStateR\x05state\x12\x1d\n" +
	"\aenabled\x18\x10 \x01(\bH\x01R\aenabled\x88\x01\x01B\x15\n" +
	"\x13_enable_transcodingB\n" +
	"\n" +
	"\b_enabled\"\xf6\x03\n" +
	"\fIngressState\x124\n" +
	"\x06status\x18\x01 \x01(\x0e2\x1c.media_router.IngressState.StatusR\x06status\x12\x14\n" +
	"\x05error\x18\x02 \x01(\tR\x05error\x12.\n" +
	"\x05video\x18\x03 \x01(\v2\x18.media_router.InputVideoStateR\x05video\x12.\n" +
	"\x05audio\x18\x04 \x01(\v2\x18.media_router.InputAudioStateR\x05audio\x12\x17\n" +
	...
	"resourceId\x12*\n" +
	"\x06tracks\x18\x06 \x03(\v2\x12.media_router.TrackInfoR\x06tracks\"{\n" +
	"\x06Status\x12\x15\n" +
	...
	"\x05items\x18\x01 \x03(\v2\x14.media_router.IngressInfoR\x05items\"5\n" +
	...
	"\aIngress\x12D\n" +
	"\rCreateIngress\x12\x1d.media_router.CreateIngressRequest\x1a\x14.media_router.IngressInfo\x12D\n" +
	"\rUpdateIngress\x12\x1d.media_router.UpdateIngressRequest\x1a\x14.media_router.IngressInfo\x12H\n" +
	"\vListIngress\x12\x1b.media_router.ListIngressRequest\x1a\x1c.media_router.ListIngressResponse\x12D\n" +
	"\rDeleteIngress\x12\x1d.media_router.DeleteIngressRequest\x1a\x14.media_router.IngressInfoBNZ+github.com/media_routerofficial/protocol/media_router\xaa\x02\rVibTree.Proto\xea\x02\x0eVibTree::Protob\x06proto3"

var (
	file_media_router_ingress_proto_rawDescOnce sync.Once
	file_media_router_ingress_proto_rawDescData []byte
)

func file_media_router_ingress_proto_rawDescGZIP() []byte {
	file_media_router_ingress_proto_rawDescOnce.Do(func() {
		file_media_router_ingress_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_media_router_ingress_proto_rawDesc), len(file_media_router_ingress_proto_rawDesc)))
	})
...
var file_media_router_ingress_proto_goTypes = []any{
...
func file_media_router_ingress_proto_init() {
	...
	file_media_router_ingress_proto_msgTypes[0].OneofWrappers = []any{}
	file_media_router_ingress_proto_msgTypes[1].OneofWrappers = []any{
		(*IngressAudioOptions_Preset)(nil),
		(*IngressAudioOptions_Options)(nil),
	}
	file_media_router_ingress_proto_msgTypes[2].OneofWrappers = []any{
		(*IngressVideoOptions_Preset)(nil),
		(*IngressVideoOptions_Options)(nil),
	}
	file_media_router_ingress_proto_msgTypes[5].OneofWrappers = []any{}
	file_media_router_ingress_proto_msgTypes[9].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_media_router_ingress_proto_rawDesc), len(file_media_router_ingress_proto_rawDesc)),
			NumEnums:      4,
			NumMessages:   13,
			NumExtensions: 0,
			NumServices:   1,
