...
func (t *AccessToken) SetKind(kind media_router.ParticipantInfo_Kind) *AccessToken {
...
func (t *AccessToken) SetRoomConfig(config *media_router.RoomConfiguration) *AccessToken {
	if config == nil {
...
func (t *AccessToken) SetAgents(agents ...*media_router.RoomAgentDispatch) *AccessToken {
